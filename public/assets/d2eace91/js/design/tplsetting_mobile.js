...
function getHelper(id) {
	...
	$(".drop-item").each(function(i, v) {
		...
		var element = $($.parseHTML("<tr " + cardinal + " data-id='" + uid + "'><td class='tcheck w30'><input class='checkBox table-list-checkbox' value='" + uid + "' type='checkbox'></td><td><span class='columnParent'>" + tpl_type + "</span><span class='columnNameText' id='columnNameText_" + uid + "'>" + title + "</span></td>" + "<td><span class='ico-switch open' onclick=setIsValidTpls('" + uid + "')> " + is_valid_class + "</span></td>" + "<td class='handle'><a href=javascript:delTpls('" + uid + "') title='删除'><i class='fa fa-trash-o'></i></a></a></a><a class='handle' href=javascript:setSortTpls('" + uid + "','up') title='上移'><i class='fa fa-arrow-circle-o-up'></i></a><a class='handle' href=javascript:setSortTpls('" + uid + "','down') title='下移'><i class='fa fa-arrow-circle-o-down'></i></a></td></tr>"));
		if (id != '' && id == uid) {
