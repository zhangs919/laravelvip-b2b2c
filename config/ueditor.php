...
return [
    // 存储引擎: config/filesystem.php 中 disks， public 或 qiniu 或 oss
    'disk' => 'oss',
    'route' => [
        'name' => '/ueditor/server',
        'options' => [
...
//        'imagePathFormat' => '/uploads/image/{yyyy}/{mm}/{dd}/', /* 上传保存路径,可以自定义保存路径和文件名格式 */
        'imagePathFormat' => '/images/ueditor/image/{yyyy}/{mm}/{dd}/', /* 上传保存路径,可以自定义保存路径和文件名格式 */
        ...
        'catcherPathFormat' => '/images/ueditor/xiumi/image/{yyyy}/{mm}/{dd}/', /* 上传保存路径,可以自定义保存路径和文件名格式 */
