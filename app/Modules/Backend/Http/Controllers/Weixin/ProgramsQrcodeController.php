...
class ProgramsQrcodeController extends Backend
{
    ...
    public function lists(Request $request)
    {
        ...
        if ($request->ajax()) {
            $render = view('weixin.programs-qrcode.partials._list', $compact)->render();
            return result(0, $render);
        }

        return view('weixin.programs-qrcode.list', $compact);
    }
    ...
    public function add(Request $request)
    {
        ...
        return view('weixin.programs-qrcode.add', $compact);
    }
    ...
    public function saveData(Request $request)
    {
        ...
        return redirect('/weixin/programs-qrcode/list');
    }
