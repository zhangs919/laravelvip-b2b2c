...
Route::group(['domain' => config('lrw.seller_domain')], function ($router) {
    ...
    Route::group(['prefix' => 'design'], function () {
        ...
        Route::group(['prefix' => 'tpl-setting'], function () {
            Route::get('setup/{page?}/{topic_id?}', 'Design\TplSettingController@setup'); // setup
            ...
            Route::get('qrcode.html', 'Design\TplSettingController@qrCode'); // 生成店铺二维码
            ...
            Route::post('set-static.html', 'Design\TplSettingController@setStatic'); // 开启/关闭静态页面

            Route::get('ref-shop-header.html', 'Design\TplSettingController@refShopHeader'); // 刷新店铺头部
