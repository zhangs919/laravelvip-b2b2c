...
@section('content')
        ...
        <div class="app-download-tip-box">
            <div class="app-download-tip">
                ...
                <div class="tip-info">
                    ...
                    <div class="tip-text">
                        <h4>享受更加流畅的商城体验</h4>
                        <p>赶快下载商之翼B2B2C商城演示站APP</p>
                    </div>
                </div>
                <a class="download-btn" href="#" data-ios="http://www.68dsw.com/app_down/ios-down.html" data-android="http://www.68dsw.com/app_down/android-down.html">立即下载</a>
            </div>
        </div>
    </div>
    <script type="text/javascript">
    ...
    <header class="header-con header-con2">
        <div class="header">
            <div class="header-content">
                ...
                <div class="qrcode SZY-SCANQRCODE-LEFT"></div>
                ...
                <div class="nav-wap-right">
                    <a href="/user/message/internal.html">
                        <em class="top-right">
                            <i class="message-num SZY-INTERNAL-COUNT hide">0</i>
                        </em>
                ...
                <div class="search-info">
                    ...
                    <div class="text-box">
                        <form id="headerSearchForm" method="get" name="" action="/search.html" onSubmit="">
                            ...
                            <input type="text" class="text" id="keyword" name="keyword" tabindex="9" autocomplete="off" data-searchwords="沃噔" data-placeholder="沃噔神器" placeholder="沃噔神器" value="">
    ...
    <div class="footer-nav">
        ...
        <ul>
            ...
            <li class="current">
                ...
                <!---->
                <a href="javascript:void(0)" class="index-icon">
                    <em class="bg-color"></em>
                </a>
                <!---->
            </li>
                        ...
                        if (result.code == 0) {
                            ...
                            wx.ready(function() {
                                ...
                                wx.onMenuShareAppMessage({
                                    title: '啊啊啊', // 标题
                                    desc: 'sad撒多按时', // 描述
                                    imgUrl: 'http://68yun.oss-cn-beijing.aliyuncs.com/images/15164/system/config/seo_index/seo_index_image_0.png', // 分享的图标
                                    link: url,
                                    fail: function(res) {
    ...
    <script type="text/javascript">
        $.get('/site/get-session-id', {}, function(result) {
            WS_AddOrder({
                user_id: result.data,
                url: "ws://push.yunmall.laravelvip.com:7272",
