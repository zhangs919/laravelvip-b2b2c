...
//        }
        ...
        $data = [
            ...
            'frame_rate' => 24,
            'height' => $height,
            'host' => $host, //'http://68yun.oss-cn-beijing.aliyuncs.com/images/',
            'name' => $name,
            'path' => $path, // /videos/shop/1/gallery/2019/03/17/15527929444336.mp4
            'poster' => $url.'!poster.png', //'http://68yun.oss-cn-beijing.aliyuncs.com/images/videos/shop/1/gallery/2019/03/17/15527929444336.mp4!poster.png',
            'sample_rate' => '48000', // 采样率
            'shop_id' => 0, //$shop_id,
            'site_id' => 0, //$site_id,
            'size' => $filesize, // 42768
            'sort' => 255,
            'url' =>  $url, // http://68yun.oss-cn-beijing.aliyuncs.com/images/videos/shop/1/gallery/2019/03/17/15527929444336.mp4
