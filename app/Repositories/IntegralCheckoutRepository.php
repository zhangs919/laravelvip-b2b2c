...
/**
 * todo 此方法是从CheckoutRepository.php复制的，后面再重写积分商城的下单逻辑
 *
 * Class IntegralCheckoutRepository
...
//                'pay_name' => null,
            ...
            if ($type == 1) {
				...
				$checkout_submit_data['data']['order']['balance'] = $checkoutData['balance'] ?? 0;
				$checkout_submit_data['data']['order']['balance_enable'] = $checkoutData['balance_enable'] == '1' ? true : false;
            } elseif ($type == 4) {
                // 修改发票信息
...
//dd($item['shop_info']);
                ...
                $order = [
                    ...
                    'money_paid' => $item['order']['order_amount'], // todo 订单实际需要支付金额 todo 如果是在线支付，则有值；余额支付支付时，为0.00
