            ...
            <div class="compare-content clearfix">
                ...
                <div class="compare-list">
                    <ul class="compare-list-con clearfix">
                        ...
                        <li class="compare-goods" name="goods_id{{ $v['goods_id'] }}">
                            <ul class="clearfix">
                                <li class="list-row-item goods-info">
                                    ...
                                    <div class="slide-buy-box clearfix">
                                        <div class="btns clearfix">
                                            <a data-tip="{{ $v['goods_id'] }}" class="cart-btn add-to-cart">加入购物车</a>
                                ...
                                <li class="list-row-item freight">
                                    <p>
                                        <strong class="rmb">
                                            <span class="rmb-num freught">￥{{ $v['goods_freight_fee'] }}</span>
                                        </strong>
                                    </p>
                                    <p class="distance">
                                        {{ $v['region_code'] }}&nbsp;至&nbsp;
                        ...
                        @if(count($list) == 2)
                                <li class="compare-goods">
                                    <ul class="clearfix">
                                        <li class="list-row-item goods-info goods-info_novalue">-</li>
                                        <li class="list-row-item price price_novalue">-</li>
                                        <li class="list-row-item freight freight_novalue">-</li>
                                        <li class="list-row-item sales sales_novalue">-</li>
                                        <li class="list-row-item reputation reputation_novalue">-</li>
                                    </ul>
                                </li>
                        @endif
                    </ul>
        ...
        <div class="compare compare-current compare-shop">
            ...
            <div class="compare-content clearfix">
                ...
                <div class="compare-list">
                            ...
                            <ul class="clearfix">
                                ...
                                <li class="list-row-item security_services more-shop-info">
                                    {{--<a class="item-icon" href="javascript:void(0)" title="破损补寄" target="_blank">
                                        <img src="http://images.laravelvip.com/contract/2016/06/07/14653028611314.jpg" />
                                    </a>
                                    <a class="item-icon" href="javascript:void(0)" title="品质承诺" target="_blank">
                                        <img src="http://images.laravelvip.com/contract/2016/06/07/14653028223253.png" />
                                    </a>--}}
                                    -
                                </li>
                        ...
                        @if(count($list) == 2)
                            <li class="compare-goods">
                                <ul class="clearfix">
                                    ...
                                    <li class="list-row-item">-</li>
                                    <li class="list-row-item grade">-</li>
                                    <li class="list-row-item more-shop-info">-</li>
                                    <li class="list-row-item more-shop-info">-</li>
                                    <li class="list-row-item more-shop-info">-</li>
                                    <li class="list-row-item security_services more-shop-info">-</li>
                                    <li class="list-row-item more-shop-info">-</li>
                                </ul>
                            </li>
                        @endif
                    ...
                    <ul class="clearfix">
                        <li class="list-row-item shop_item_blank">展开详情信息</li>
                    </ul>
                </div>
            </div>
        </div>
