    ...
    <div class="content">
        ...
        <div class="operat-tips">
            ...
            <ul class="operat-panel">
                ...
                <li>
                    <span>公司类信息需填项较多，建议先查看公司信息注意事项再进行填写；</span>
                </li>
                <li>
                    <span>以下所需上传电子版资质仅支持jpg、gif、png格式的图片，大小不超过2M，且必须加盖企业或组织彩色公章。</span>
                </li>
            </ul>
        </div>
        ...
        <form id="ShopFieldValueModel" class="form-horizontal" name="ShopFieldValueModel" action="/shop/apply/auth-info.html?is_supply={{ $is_supply }}&amp;shop_type={{ $shop_type }}" method="post" enctype="multipart/form-data">
            ...
            <div class="item-box">
                <div class="title">
                    <span>企业信息</span>
                    <span class="notes">（按照证书上的内容逐字填写）</span>
                </div>


                <div class="form-group form-group-spe" >
                    <label for="shopfieldvaluemodel-company_name" class="input-left">
                    ...
                    <div class="form-control-box">
                        ...
                        <input type="text" id="shopfieldvaluemodel-company_name" class="form-control" name="ShopFieldValueModel[company_name]">
                ...
                <div class="form-group form-group-spe" >
                    <label for="shopfieldvaluemodel-unified_social_credi" class="input-left">
                        <span class="spark">*</span>
                        <span>统一社会信用代码：</span>
                    </label>
                    <div class="form-control-box">
                        ...
                        <input type="text" id="shopfieldvaluemodel-unified_social_credi" class="form-control" name="ShopFieldValueModel[unified_social_credi]">
            ...
            <div class="item-box">
                ...
                <div class="form-group form-group-spe" >
                    <label for="shopfieldvaluemodel-artificial_person" class="input-left">
                        <span class="spark">*</span>
                        <span>法人代表姓名：</span>
                    </label>
                    <div class="form-control-box">
                        ...
                        <input type="text" id="shopfieldvaluemodel-artificial_person" class="form-control" name="ShopFieldValueModel[artificial_person]">
            ...
            <div class="item-box">
                ...
                <div class="form-group form-group-spe pic-box">
                    ...
                    <div class="form-control-box">
                        ...
                        <div id="img_license" class="image-uploader">
                            <!--当没有上传的情况下，显示-->
                            <div class="fild-box" >
                                <i></i>
                                <span class="fild-text">点击此处选择上传</span>
                                <input class="fild-hidden" type="file" value="点击上传" id="shopfieldvaluemodel-license" name="ShopFieldValueModel[license]" />
                            </div>
                            <!--当点击上传时，显示的缓载效果-->
                            ...
                            <div class="image-wrap">
                                ...
                                <img >
                                <input type="hidden" name="check-license" id="check-license"  />
                            </div>
                        </div>
                        <div class="examples">
                            <label class="input-left">
                    ...
                    <div class="invalid">
                        <span class="hint">营业执照、组织机构代码证、税务登记证三证合一；图片建议请使用700*900像素jpg、gif、png格式的图片，并且图片大小不得超过2M</span>
                    </div>
                </div>
            ...
            <div class="item-box">
                ...
                <div class="form-group form-group-spe" >
                    <label for="shopfieldvaluemodel-card_type" class="input-left">
                        <span class="spark">*</span>
                        <span>身份证类型：</span>
                    </label>
                    <div class="form-control-box">
...
[
		...
		{
			"id": "shopfieldvaluemodel-license",
			"name": "ShopFieldValueModel[license]",
			"attribute": "license",
			"rules": {
				"required": true,
				"messages": {
    ...
    <script type="text/javascript">
        ...
        $("#shopfieldvaluemodel-license").uploadPreview({
            Img: "img_license",
            Width: 200,
            Height: 120
        });
