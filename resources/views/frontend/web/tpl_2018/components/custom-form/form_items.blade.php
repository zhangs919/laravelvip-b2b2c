    ...
    @case("upload_file")
        <div class="question-conent">
            <div class="upload-box">
                ...
                <div id="ossfile_{{ $k }}" class="_ossfile">你的浏览器不支持flash,Silverlight或者HTML5！</div>


                <div id="container_{{ $k }}" class="_container">
                    <a id="selectfiles_{{ $k }}" href="javascript:void(0);" class="btn btn-default _selectfiles">选择文件</a>
                    <a id="postfiles_{{ $k }}" href="javascript:void(0);" class="btn btn-primary _postfiles">开始上传</a>
                </div>
                <input type="hidden" name="upload_file_{{ $k }}" class="_filename" id="upload_file_{{ $k }}" value="">
                <input type="hidden" name="upload_file_{{ $k }}_txt" class="_filetext" id="upload_file_{{ $k }}_txt" value="">
            </div>
        </div>
    @break
    ...
    @case("weixin")
        <div class="question-conent">
            <div class="item-input-box">
                ...
                <input type="text" class="item-input" name="weixin_{{ $k }}" style="width: 300px;" value="{{ $form['title_default_value'] ?? '' }}">
            </div>
        </div>
    @break
    ...
    @case("qq")
        <div class="question-conent">
            <div class="item-input-box">
                ...
                <input type="text" name="qq_{{ $k }}" class="item-input" style="width: 300px;" value="{{ $form['title_default_value'] ?? '' }}">
            </div>
        </div>
    @break
    ...
    @case("weibo")
        <div class="question-conent">
            <div class="item-input-box">
                ...
                <input type="text" class="item-input" name="weibo_{{ $k }}" style="width: 300px;" value="{{ $form['title_default_value'] ?? '' }}">
            </div>
        </div>
    @break
