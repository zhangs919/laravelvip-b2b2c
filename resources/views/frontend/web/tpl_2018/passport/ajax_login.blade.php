...
<div id="{{ $uuid }}" class="login-form">
    <div class="login-con pos-r">
        ...
        <div class="login-wrap ">
            ...
            <div class="login-tit">
                还不是卖家？
                <a href="/shop/apply.html" class="regist-link color">
                    立即申请
                    <i>></i>
                </a>
            </div>
...
<script type="text/javascript">
    $().ready(function() {
        ...
        $("body").on('click', '.website-login', function() {
            ...
            $.go("http://www.b2b2c.yunmall.laravelvip.com"+"/website/login?type="+type);
        })
    ...
    function REF_QRCodeLogin(view){
        $.get('/site/get-qrcode-login-key',{ },function(result){
            ...
            $('.SZY-QRCODE-LOGIN').qrcode({
                width:150,
                height:150,
                text: '/site/qrcode-login.html?k=' + result.data.key
            });
