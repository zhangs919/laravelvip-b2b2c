    ...
    <div class="w1210">
        ...
        <div class="goods-info">
            ...
            <div id="preview" class="preview">
                ...
                <div class="goods-gallery-bottom">
                    ...
                    @if(!empty($goods['button_name']) && !empty($goods['button_url']))
                        <!-- 自定义按钮 -->
                        <a href="{{ get_image_url($goods['button_url']) }}" class="download bg-color fr" target="_blank">{{ $goods['button_name'] }}</a>
                    @endif

                    <a href="javascript:void(0);" class="goods-compare compare-btn fr add-compare @if($goods['is_compare']){{ 'curr' }}@endif" data-goods-id="{{ $goods['goods_id'] }}" data-sku-id="{{ $sku['sku_id'] }}" data-image-url="{{ get_image_url($goods['goods_image']) }}?x-oss-process=image/resize,m_pad,limit_0,h_320,w_320">
                        @if($goods['is_compare'])
                            <i class="iconfont">&#xe6ae;</i>
                        @else
                            <i class="iconfont">&#xe715;</i>
                                                    ...
                                                    <div class="prom-gift">
                                                        ...
                                                        <div class="prom-gift-list SZY-GIFT m-l-5">
                                                            <a href="/1112.html" title="彩椒  C之王" target="_blank">
                                                                <img src="http://xxx.oss-cn-beijing.aliyuncs.com/images/15164/shop/1/gallery/2019/01/15/15475140324781.png?x-oss-process=image/resize,m_pad,limit_0,h_80,w_80" width="25" height="25" class="gift-img" />
                                                            </a>
                                                        ...
                                                        <div class="prom-gift-list SZY-GIFT m-l-5">
                                                            <a href="/1127.html" title="彩椒 123 1" target="_blank">
                                                                <img src="http://xxx.oss-cn-beijing.aliyuncs.com/images/15164/shop/1/gallery/2019/01/11/15472021222241.jpg?x-oss-process=image/resize,m_pad,limit_0,h_80,w_80" width="25" height="25" class="gift-img" />
                                                            </a>
                                                            <em class="gift-number color">× 1</em>
                                                        </div>
                ...
                <dl class="store-score">
                    <dd>
                        ...
                        <div class="score-sum color">
                            {{ format_price(round(($shop_info['shop']['desc_score']+$shop_info['shop']['service_score']+$shop_info['shop']['send_score']) / 3, 2)) }}
                            <span>综合</span>
                        </div>
                        <ul class="score-part">
                            <li>
        ...
        <div class="clearfix">
            ...
            <div class="fl">
                    ...
                    <div class="store-service-group left-content">
                        ...
                        <div class="store-service-type first">
                            ...
                            <div class="service-list">
                                <em>{{ $v['customer_type_name'] }}</em>


                                @if($v['customer_tool'] == 1){{--QQ--}}
                                <a target="_blank" href="http://wpa.qq.com/msgrd?v=3&uin={{ $v['customer_account'] }}&site=qq&menu=yes" class="service-btn">
                                    <img border="0" onload="load_qq_customer_image(this, 'http://')" src="http://wpa.qq.com/pa?p=2:{{ $v['customer_account'] }}:52" alt="QQ" title="点击这里给我发消息" style="height: 20px;" />
                                    <span>{{ $v['customer_name'] }}</span>
                                </a>
                                @elseif($v['customer_tool'] == 2){{--旺旺--}}
                                ...
                                @elseif($v['customer_tool'] == 3){{--云客服--}}
                                <a href="{{ $yikf_url }}" class="service-btn " target="_blank">
                                    <i class="iconfont color"></i>
                                    <span>{{ $v['customer_name'] }}</span>
                                </a>
                                @endif
                ...
                <div class="aside-con">
                    <h2 class="aside-tit">您浏览过</h2>
                    <ul class="aside-list">

                        @foreach($goods_history as $v)
                        <li>
                            <div class="p-img">
                                <a href="/goods-{{ $v['goods_id'] }}.html" target="_blank" title="{{ $v['goods_name'] }}">
                                    <img src="{{ get_image_url($v['goods_image']) }}?x-oss-process=image/resize,m_pad,limit_0,h_220,w_220" alt="{{ $v['goods_name'] }}">
                                </a>
                            </div>
                            <div class="p-name">
                                <a href="/goods-{{ $v['goods_id'] }}.html" target="_blank" title="{{ $v['goods_name'] }}">{{ $v['goods_name'] }}</a>
                            </div>
                            <div class="p-price">
                                <span class="sale-price color">{{ $v['goods_price'] }}</span>
                            </div>
                        </li>
                        @endforeach
        ...
        function setSkuInfo(sku) {
            ...
            if (sku.activity && sku.activity.act_type == '11' && sku.activity.act_status == 1) {
                ...
                if (sku.activity.discount_mode == 0) {
                    ...
                    discount_msg = '优惠 ' + (sku.original_price - sku.activity.discount_num).toFixed(2);
                } else {
                    discount_msg = '--';
                }
