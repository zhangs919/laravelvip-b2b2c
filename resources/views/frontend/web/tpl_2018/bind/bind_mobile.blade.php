                ...
                <div class="reg-wrap">
                    <div class="reg-wrap-con" id="con_register_2" style="background: url(/images/register-bg.jpg) no-repeat right 70px;">
                        ...
                        <div class="login-radio">
                            ...
                            <label id="login2" onclick="javascript:$.go('/bind/bind/email')">
                                <input type="radio" value="" name="register" />
                                <span>邮箱注册</span>
                            </label>
                        </div>
                        <!-- 手机注册 star -->
                        <form id="MobileRegisterModel" class="form-horizontal" name="MobileRegisterModel" action="/bind/bind/mobile.html" method="post">
                            @csrf
                            <div class="form-group form-group-spe" >
                                ...
                                <div class="form-control-box">
                                    <input type="text" id="mobileregistermodel-mobile" class="form-control" name="MobileRegisterModel[mobile]">
                                </div>
                            ...
                            <div class="form-group form-group-spe" >
                                ...
                                <div class="form-control-box">
                                    <input type="password" id="password" class="form-control" name="MobileRegisterModel[password]" value="" autocomplete="off">
                            ...
                            <div class="form-group form-group-spe" >
                                ...
                                <div class="form-control-box">
                                    ...
                                    <label class="captcha">
                                        <img id="captcha-image" class="captcha-image" name="MobileRegisterModel[captcha]" src="/site/captcha.html?v=5fa54d9601770" alt="点击换图" title="点击换图" style="vertical-align: middle; cursor: pointer;"><script data-captcha-id="captcha-image" type="text">{"refreshUrl":"\/site\/captcha.html?refresh=1","hashKey":"niiCaptcha\/site\/captcha"}</script>
                                    </label>
                                </div>
                                <div class="invalid"></div>
                            </div>
...
[{"id": "mobileregistermodel-mobile", "name": "MobileRegisterModel[mobile]", "attribute": "mobile", "rules": {"required":true,"messages":{"required":"手机号不能为空。"}}},{"id": "mobileregistermodel-password", "name": "MobileRegisterModel[password]", "attribute": "password", "rules": {"required":true,"messages":{"required":"密码不能为空。"}}},{"id": "mobileregistermodel-sms_captcha", "name": "MobileRegisterModel[sms_captcha]", "attribute": "sms_captcha", "rules": {"required":true,"messages":{"required":"短信校验码不能为空。"}}},{"id": "mobileregistermodel-mobile", "name": "MobileRegisterModel[mobile]", "attribute": "mobile", "rules": {"match":{"pattern":/^((13|15|18|17|14)\d{9}|(199|195|198|166|191|167)\d{8})$/,"not":false,"skipOnEmpty":1},"messages":{"match":"手机号是无效的。"}}},{"id": "mobileregistermodel-mobile", "name": "MobileRegisterModel[mobile]", "attribute": "mobile", "rules": {"ajax":{"url":"/register/client-validate","model":"c2VydmljZVxyZWdpc3Rlclxtb2RlbHNcTW9iaWxlUmVnaXN0ZXJNb2RlbA==","attribute":"mobile","params":[]},"messages":{"ajax":"{attribute}\"{value}\"已被注册。"}}},{"id": "mobileregistermodel-password", "name": "MobileRegisterModel[password]", "attribute": "password", "rules": {"password":{"pattern":/^[^\u4e00-\u9fa5\·]{6,20}$/,"not":false,"skipOnEmpty":1},"match":{"pattern":/\s+/,"not":true,"skipOnEmpty":1},"messages":{"password":"密码长度为6-20个字符，建议由字母、数字和符号两种以上。","match":"密码不能包含空格。"}}},
{{--{"id": "mobileregistermodel-captcha", "name": "MobileRegisterModel[captcha]", "attribute": "captcha", "rules": {"captcha":{"hash":426,"hashKey":"niiCaptcha/site/captcha","caseSensitive":false},"messages":{"captcha":"验证码不正确。"}}},--}}
]
</script>
