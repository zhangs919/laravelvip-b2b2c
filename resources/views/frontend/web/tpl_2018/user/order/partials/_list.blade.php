                    ...
                    <tr class="trade-order-info">
                        <td colspan="2">
                            <label>
                                ...
                                <span style="">{{ format_time($v->add_time) }}</span>
                            </label>
                            <span>订单号：</span>
                    ...
                    <tr>
                            ...
                            <div style="overflow: hidden;">
                                ...
                                <div class="item-con">
                                    ...
                                    <div class="item-icons">
                                        <a class="item-icon" href="javascript:void(0);" title="【品质承诺】卖家就该商品品质向买家作出承诺，承诺商品为正品。">
                        ...
                        <td class="goods-operate">
                            ...
                            <div class="operate">
                                ...
                                {{--取消订单--}}
                                <a class="cancel-payment edit-order" data-id="266" data-type="cancel">取消订单</a>
                        ...
                        <td class="goods-payment" rowspan="{{ count($v->order_goods) }}">
                            ...
                            <p>
                                待付款：
                                <strong class="second-color">￥{{ $v->order_amount }}</strong>
                            </p>
                            ...
                            <p>
                                <span>{{ format_pay_type($v->pay_type) }}</span>
                            </p>

                        </td>
                        <td class="trading-status" rowspan="{{ count($v->order_goods) }}">
                            <div class="operate">
                                交易关闭
                            </div>
                        ...
                        <td class="trading-operate dismantle" rowspan="{{ count($v->order_goods) }}"></td>
