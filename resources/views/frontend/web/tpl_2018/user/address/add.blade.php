<form id="UserAddressModel" class="form-horizontal" name="UserAddressModel" action="/user/address/add?checkout={{ $checkout }}" method="post">
    @csrf
...
-->
    ...
    <div class="form-group form-group-spe" >
        ...
        <div class="form-control-box">
            <input type="text" id="useraddressmodel-mobile" class="form-control" name="UserAddressModel[mobile]" placeholder="请填写收货手机号码">
    ...
    <div class="form-group form-group-spe" >
        ...
        <div class="form-control-box">
            <input type="text" id="useraddressmodel-tel" class="form-control" name="UserAddressModel[tel]" placeholder="xxxx-xxxxxxx">
