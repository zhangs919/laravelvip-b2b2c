...
@section('content')
    ...
    <div class="addressmone1">
        <form id="UserAddressModel" class="form-horizontal" name="UserAddressModel" action="/user/address/add.html?back_url=/user/address.html" method="post">
            {{ csrf_field() }}

            <input type="hidden" id="address_lng" class="address_lng" name="UserAddressModel[address_lng]">

            <input type="hidden" id="address_lat" class="address_lat" name="UserAddressModel[address_lat]">
            <div class="form-group-box">
                        ...
                        <dl>
                            ...
                            <dd>
                                <div class="form-control-box">
                                    ...
                                    <input type="text" id="useraddressmodel-consignee" class="consignee" name="UserAddressModel[consignee]" autocomplete="off" placeholder="你的姓名">
                        ...
                        <dl>
                            ...
                            <dd>
                                <div class="form-control-box">
                                    ...
                                    <input type="number" id="useraddressmodel-mobile" class="mobile" name="UserAddressModel[mobile]" autocomplete="off" placeholder="你的手机号" pattern="[0-9]*">
                ...
                <div class="address-info-bd">
                        ...
                        <dl>
                            ...
                            <dd>
                                <div class="form-control-box">
                                    ...
                                    <input type="hidden" id="address_detail" class="form-control" name="UserAddressModel[address_detail]" placeholder="输入详细地址">
					...
					<font>自定义</font>
					<input type="hidden" id="useraddressmodel-address_label" class="label-custom-input" name="UserAddressModel[address_label]">
				</span>
                                    </div>
