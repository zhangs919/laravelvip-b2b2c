...
@section('content')
    ...
    <div class="con">
        ...
        <form id="BackOrder" class="form-horizontal" name="BackOrder" action="/user/back/edit.html?id={{ $back_info['back_id'] }}" method="post">
            @csrf
            <input type="hidden" id="backorder-back_type" class="form-control" name="BackOrder[back_type]" value="{{ $back_info['back_type'] }}">
            <ul class="back-box">
                <li class="ub">
                    <div class="back-li-l">
                        <em class="color">*</em>
                ...
                <li class="ub hide" id="con_back_number">
                    ...
                    <div class="ub-f1 back-li-r">
                        ...
                        {{ $back_info['back_number'] }} <input type="hidden" id="backorder-back_number" class="form-control" name="BackOrder[back_number]" value="{{ $back_info['back_number'] }}">
                ...
                <li class="ub">
                    ...
                    <div class="ub-f1 back-li-r">
                        ...
                        <input type="text" id="backorder-refund_money" class="form-control" name="BackOrder[refund_money]" value="{{ $back_info['refund_money'] }}" readonly>
                ...
                <li class="ub">
                    ...
                    <input type="hidden" id="backorder-refund_type" class="form-control" name="BackOrder[refund_type]" value="{{ $back_info['refund_type'] }}">
                </li>
                <li class="ub">
                    <div class="back-li-l">
                        <em class="color">*</em>
                    ...
                    <div class="ub-f1 back-li-r"><textarea id="backorder-back_desc" class="form-control" name="BackOrder[back_desc]" rows="3" placeholder="建议您如实填写...">{!! $back_info['back_desc'] !!}</textarea></div>
                </li>

                <li class="back-imgs clearfix">
                    <div class="image-container">
                    </div>
                    <input type="hidden" id="img_path_{{ $back_info['back_id'] }}" name="img_path" value="{{ $back_info['img_path'] }}">

                    <div class="img-uploading-list img-uploading " data-sku-id="{{ $back_info['back_id'] }}">
                        <h4>
                            <i class="iconfont">&#xe635;</i>
                        </h4>
                        <p>上传凭证</p>
    ...
    <div class="prompt-choose hide back-type-con">
        ...
        <ul class="prompt-choose-reason">
            <li class="@if($back_info['back_type'] == 1){{ 'seleted' }}@endif" data-url="/user/back/apply.html?id={{ $back_info['order_id'] }}&record_id={{ $back_info['record_id'] }}&gid={{ $back_info['goods_id'] }}&sid={{ $back_info['sku_id'] }}&back_type=1">仅退款</li>
            <li class="@if($back_info['back_type'] == 2){{ 'seleted' }}@endif" data-url="/user/back/apply.html?id={{ $back_info['order_id'] }}&record_id={{ $back_info['record_id'] }}&gid={{ $back_info['goods_id'] }}&sid={{ $back_info['sku_id'] }}&back_type=2">退货退款</li>
        </ul>
    ...
    <div class="prompt-choose hide back-refund-con">
        ...
        <ul class="prompt-choose-reason">
            <li data-val='0' class="@if($back_info['refund_type'] == 0){{ 'seleted' }}@endif">退回账户余额</li>
            <li data-val='1' class="@if($back_info['refund_type'] == 1){{ 'seleted' }}@endif">退回原支付方式</li>
        </ul>
        <div class="prompt-choose-bottom pos-r">
            <button type="button" class="btn btn-default" onclick="close_choose()">取消</button>
    ...
    <div class="prompt-choose hide back-reason-con">
        ...
        <ul class="prompt-choose-reason">
            @foreach($refund_reason_list as $key=>$item)
                <li data-val='{{ $key }}' class="@if($back_info['back_reason'] == $key){{ 'seleted' }}@endif">{{ $item }}</li>
            @endforeach
        </ul>
        <div class="prompt-choose-bottom pos-r">
            <button type="button" class="btn btn-default" onclick="close_choose()">取消</button>
    ...
    <div class="prompt-choose hide back-exchange-con">
        ...
        <ul class="prompt-choose-reason">
            @foreach($exchange_reason_list as $item)
                <li data-val='{{ $item }}' class="@if($back_info['exchange_reason'] == $item){{ 'seleted' }}@endif">{{ $item }}</li>
            @endforeach
        </ul>
        <div class="prompt-choose-bottom pos-r">
            <button type="button" class="btn btn-default" onclick="close_choose()">取消</button>
    ...
    <div class="prompt-choose hide back-repair-con">
        ...
        <ul class="prompt-choose-reason">
            @foreach($format_repair_reason as $item)
                <li data-val='{{ $item }}' class="@if($back_info['repair_reason'] == $item){{ 'seleted' }}@endif">{{ $item }}</li>
            @endforeach
        </ul>
        <div class="prompt-choose-bottom pos-r">
            <button type="button" class="btn btn-default" onclick="close_choose()">取消</button>
