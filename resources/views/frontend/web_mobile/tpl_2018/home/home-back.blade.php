...
@section('header_js')
    ...
    <script src="/assets/40c2dc05/js/swiper/swiper.jquery.min.js?v=1.1"></script>
    ...
    <script src="/assets/40c2dc05/js/geolocation/amap.js?v=1.1"></script>
    <script src="//res.wx.qq.com/open/js/jweixin-1.6.0.js?v=1.1"></script>
    <script src="//webapi.amap.com/maps?v=1.4.6&amp;key=7aa941b5dff0631b1b5b494bc29cce01&amp;v=1.1"></script>
