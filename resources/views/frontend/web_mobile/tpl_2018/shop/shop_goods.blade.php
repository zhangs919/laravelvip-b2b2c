...
<script type='text/javascript'>
    $(document).ready(function() {
        ...
        $('body').on('click', '.GO-GOODS-INFO', function() {
            ...
            history.pushState(null, '鲜农乐食品专营店-商之翼 · 云商城', page_url);
...
<div class="yikf-form site_yikf_form" id="yikf-kefu" style='display:none;'>
    <form id='yikf-form'class="yikf-item" action="https://kf.yunmall.68mall.com/index/index/home?business_id=eb5bf6642a5afe7621241a51842b901c&groupid=&shop_id=1&goods_id=0" method="post" >
