...
<head>
    ...
    <!-- 购物车js -->
    <!--整站改色 _start-->
    <link href="/css/shop_header.css?v=2" rel="stylesheet">
    <link href="/css/shop_coupon.css?v=20201012" rel="stylesheet">
    <link href="/css/bonus_message.css?v=20201012" rel="stylesheet">
    <link href="/css/template.css?v=20201012" rel="stylesheet">
    <link href="/css/dianpu.css?v=2" rel="stylesheet">
    ...
    @else
        <link rel="stylesheet" href="http://{{ config('lrw.mobile_domain') }}/css/color-style.css?v=1.3" id="site_style"/>
    @endif
    <link href="/assets/d2eace91/css/swiper/swiper.min.css?v=20201012" rel="stylesheet" position="1">
    <link href="/css/iconfont/iconfont.css?v=20201012" rel="stylesheet">
    <link href="/css/common.css?v=22" rel="stylesheet">
    <link href="/css/online.css?v=20201012" rel="stylesheet">
...
<div class="shop-index-box">
    ...
    <!-- 云客服 -->
    <div class="yikf-form site_yikf_form" id="yikf-kefu" style='display:none;background:url({{ get_image_url(sysconf('m_aliim_icon')) }}) no-repeat; background-size: cover;' >
        <form id='yikf-form'class="yikf-item" action="https://1737.kf.mall.xxx.com/index/index/home?business_id=xxxx&groupid=&shop_id=0&goods_id=0" method="post" >
...
<div class="sidebar-section">
    <p class="shop-detail">手机扫码访问</p>
    <div class="qr-code SZY-QRCODE"></div>
</div>
<script type="text/javascript">
    //
</script>
...
<script src="/js/shop.js?v=20201016"></script>
<script src="/assets/d2eace91/js/szy.cart.mobile.js?v=20201016"></script>
<script src="/js/common.js?v=20201016"></script>
<script src="/assets/d2eace91/js/jquery.qrcode.min.js?v=20201016"></script>
<script src="//res.wx.qq.com/open/js/jweixin-1.6.0.js"></script>
<script src="//webapi.amap.com/maps?v=1.4.6&amp;key=7aa941b5dff0631b1b5b494bc29cce01"></script>
...
<script>
    ...
    //
    //$('.header-height').css('height',$(".shop-top-con1").outerHeight());
    //店铺公告
    ...
    $(window).bind('scroll', function() {
        var topHeight = $('.shop-top-con1').height()-44;
        var scrollHeight = $(this).scrollTop()
        if (scrollHeight >= topHeight) {
            $('.shop-nav').addClass('fixed');
        } else {
            $('.shop-nav').removeClass('fixed');
        }
    })
    //
    var is_opening = '';
