<table id="table_list" class="table table-hover">
    ...
    <tr class="toggle-btn cur-p bill_info">
        ...
        <td class="text-c">{{ format_time($item['confirm_time'], 'Y-m-d') }} </td>
        <td class="text-c">{{ format_time($item['send_bill'], 'Y-m-d') }} </td>
        <td>
            <div class="colspan-div">
        ...
        <td class="handle p-r-0">
            <a href="/trade/order/info.html?id={{ $item['order_id']}}">查看</a>
