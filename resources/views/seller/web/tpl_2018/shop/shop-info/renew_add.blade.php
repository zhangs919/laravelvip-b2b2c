...
@section('content')
    ...
    <div class="table-content m-t-30 clearfix">
        <form id="ShopPaymentModel" class="form-horizontal" name="ShopPaymentModel" action="/shop/shop-info/renew-add" method="post">
            @csrf
            <input type="hidden" id="shoppaymentmodel-shop_id" class="form-control" name="ShopPaymentModel[shop_id]" value="{{ $shop->shop_id }}">
            <!-- 平台保证金 -->
                    ...
                    <div class="col-sm-8">
                        <div class="form-control-box">
                            <select id="shoppaymentmodel-duration" class="form-control" name="ShopPaymentModel[duration]">
                                ...
                                <option value="1-month-0">1个月</option>
                                <option value="2-year-0.01">2年</option>
                                <option value="3-day-0">3天</option>
                            </select>
                        </div>
            ...
            <!-- 起始时间 -->
            <input type="hidden" id="shoppaymentmodel-begin_time" class="form-control" name="ShopPaymentModel[begin_time]" value="2020-06-21">
            <!-- 店铺到期时间 -->
