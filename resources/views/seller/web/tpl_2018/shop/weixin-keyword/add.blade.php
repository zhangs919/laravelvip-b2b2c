...
@section('content')
    ...
    <div class="table-content m-t-30 clearfix">
        <form id="WeixinKeyword" class="form-horizontal" name="WeixinKeyword" action="/shop/weixin-keyword/add" method="post" enctype="multipart/form-data">
            @csrf
            <!-- 隐藏域 -->
            ...
            <div id="content">
                ...
                <!-- ================== END BASE  ================== -->
                <!--引入菜单类型内容-->
                @include('shop.weixin-keyword.change_type_'.$model['key_type'])
