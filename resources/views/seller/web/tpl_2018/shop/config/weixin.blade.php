        ...
        <form id="ShopConfigModel" class="form-horizontal" name="ShopConfigModel" action="/shop/config/index" method="post" enctype="multipart/form-data">
            ...
            <div class="wechat">
                <div class="wechat-box">
                    ...
                    <div class="wechat-img">
                        ...
                        <img class="w80" src="{{ $qrcode }}" alt="二维码" />
                        <!--下载暂无-->
                        <a class="btn-link" href="/shop/download-qrcode?shop_id={{ $shop->shop_id ?? 0 }}">下载店铺二维码</a>
                    </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <div class="form-control-box">
                            <input type="text" id="shopconfigmodel-appid" class="form-control" name="ShopConfigModel[appid]" value="{{ $group_info['appid']->value }}">
                        </div>
            ...
            <div class="simple-form-field" >
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <div class="form-control-box">
                            <input type="text" id="shopconfigmodel-appsecret" class="form-control" name="ShopConfigModel[appsecret]" value="{{ $group_info['appsecret']->value }}">
                        </div>
                        <div class="help-block help-block-t"></div>
                    </div>
                </div>
            ...
            <div class="simple-form-field" >
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <div class="form-control-box">
                            <input type="text" id="shopconfigmodel-auth_verify" class="form-control" name="ShopConfigModel[auth_verify]" value="{{ $group_info['auth_verify']->value }}">
                        </div>
                        <div class="help-block help-block-t"></div>
                    </div>
                </div>
            ...
            <div class="simple-form-field" >
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <div class="form-control-box">
                            <input type="hidden" id="shopconfigmodel-shop_wechat" class="form-control" name="ShopConfigModel[shop_wechat]" value="{{ $group_info['shop_wechat']->value }}">
                        </div>
                        <div class="help-block help-block-t"></div>
                    </div>
                </div>
            ...
            <div class="simple-form-field">
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <div class="form-control-box">
                            <label class="control-label">http://{{ config('lrw.mobile_domain') }}/wxapi/index?shop_id={{ $shop->shop_id ?? 0 }}</label>
                        </div>
                    </div>
                </div>
            </div>
            <div class="simple-form-field p-t-0">
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <div class="form-control-box">
                            <label class="control-label">laravelvip</label>
                        </div>
                    </div>
                </div>
            </div>
