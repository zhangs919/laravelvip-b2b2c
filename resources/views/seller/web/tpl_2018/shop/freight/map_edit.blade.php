                                        ...
                                        <div class="entity">
                                            ...
                                            @foreach($info->freightRecord as $fr)
                                                ...
                                                <div class="default">
                                                    ...
                                                    <span class="cash_more" style="@if($fr->is_cash == 1) visibility: hidden; @endif">
                                                        ，需加价：
                        ...
                        <div class="col-sm-8">
                            <div class="form-control-box">
                                ...
                                <div id="mapContainer" class="amap-container">
                                    <!--左侧定位搜索盒子-->
                                    <div class="search-fixed-box" style="display: none;">
                                        <!---->
                                        <div class="searchbox">
                                            <div class="iptbox">
                                                <input class="searchipt" id="keywords" placeholder="请输入搜索地点" maxlength="256" type="text">
                                                <a class="searchbtn keywords-search">
                                                    <div class="tooltipDark animated fadeInUp">
                                        ...
                                        <div class="real-height-box" style="display: none;">
                                            <a class="close-btn" href="javascript:;">×</a>
                                            <div class="select-search-form">
                                                <div class="select-search-panel region-search-container"></div>
                                                <div class="select-search-submit">
                                                    <a class="select-search-clear hide">清除路线</a>
                                                    <a class="select-submit region-search">搜索</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <div class="form-control-box">
                                        ...
                                        <!--是否包邮弹框 star-->
                                        <div class="free-shipping free-container"style="width: 770px; @if($info->is_free == 0) display: none; @endif">
...
<span class="unit_free_start">在</span>
<input type="text" id="freightfreerecord-free_number" class="form-control small sm-height pull-none m-l-5 m-r-5" name="FreightFreeRecord[free_number]" data-rule-required="true" data-msg="包邮条件不能为空">
<span class="unit_free_end">Kg内</span>，并且满
<input type="text" id="freightfreerecord-free_money" class="form-control small sm-height pull-none m-l-5 m-r-5" name="FreightFreeRecord[free_money]" data-rule-required="true" data-msg="包邮条件不能为空">
元包邮
</script>
...
<span class="unit_free_start">在</span>
<input type="text" id="freightfreerecord-free_number" class="form-control small sm-height pull-none m-l-5 m-r-5" name="FreightFreeRecord[free_number]" data-rule-required="true" data-msg="包邮条件不能为空">
<span class="unit_free_end">Kg内</span>，或者满
<input type="text" id="freightfreerecord-free_money" class="form-control small sm-height pull-none m-l-5 m-r-5" name="FreightFreeRecord[free_money]" data-rule-required="true" data-msg="包邮条件不能为空">
元包邮
</script>
    <!-- 表单验证 -->
...
[{"name":"\u4ef6\u6570","mark":"\u4ef6","start":"\u9996\u4ef6","plus":"\u7eed\u4ef6","free_start":"\u6ee1","free_end":"\u4ef6","free_items":["\u4ef6\u6570","\u91d1\u989d","\u4ef6\u6570+\u91d1\u989d","\u4ef6\u6570\u6216\u91d1\u989d"]},{"name":"\u91cd\u91cf","mark":"Kg","start":"\u9996\u91cd","plus":"\u7eed\u91cd","free_start":"\u5728","free_end":"Kg\u5185","free_items":["\u91cd\u91cf","\u91d1\u989d","\u91cd\u91cf+\u91d1\u989d","\u91cd\u91cf\u6216\u91d1\u989d"]},{"name":"\u4f53\u79ef","mark":"m<sup>3<\/sup>","start":"\u9996\u4f53\u79ef","plus":"\u7eed\u4f53\u79ef","free_start":"\u5728","free_end":"m<sup>3<\/sup>\u5185","free_items":["\u4f53\u79ef","\u91d1\u989d","\u4f53\u79ef+\u91d1\u989d","\u4f53\u79ef\u6216\u91d1\u989d"]}]
    ...
    <script type="text/javascript" src="http://webapi.amap.com/maps?v=1.4.15&key={{ sysconf('amap_js_key') }}&&plugin=AMap.Scale,AMap.PolyEditor,AMap.Geocoder,AMap.PlaceSearch"></script>
    <script type="text/javascript">
        //当前已选择的地区
        ...
        $().ready(function() {
            ...
            addArea(map, "{{ $fr->region_path }}", "{{ $fr->region_color }}", {
                ...
                start_num: "{{ $fr->start_num }}",
                start_money: "{{ $fr->start_money }}",
                plus_num: "{{ $fr->plus_num }}",
                plus_money: "{{ $fr->plus_money }}",
                start_num: "{{ $fr->start_num }}",
                is_cash: "{{ $fr->is_cash }}",
                cash_more: "{{ $fr->cash_more }}",
                region_codes: "{{ $fr->region_codes }}",
                region_names: "{{ $fr->region_names }}",
                region_path: "{{ $fr->region_path }}",
                region_desc: "{{ $fr->region_desc }}",
            });
            //
            @endif
            @endforeach
