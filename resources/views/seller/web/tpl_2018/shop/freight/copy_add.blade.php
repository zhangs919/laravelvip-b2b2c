        ...
        <div class="content">
            ...
            <form id="form1" class="form-horizontal" name="Freight" action="/shop/freight/add?id=17" method="post" left="col-sm-3" right="col-sm-9">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <div class="form-control-box">
                                ...
                                <input type="text" id="freight-title" class="form-control" name="Freight[title]" value="全国配送">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <div class="form-control-box">
                                ...
                                <input type="hidden" id="freight-region_code" class="form-control" name="Freight[region_code]" value="13,03,02">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <div class="form-control-box">
                                ...
                                <input type="hidden" name="Freight[is_free]" value="0"><div id="freight-is_free" class="" name="Freight[is_free]"><label class="control-label cur-p m-r-10"><input type="radio" name="Freight[is_free]" value="0"> 自定义运费</label>
                                    <label class="control-label cur-p m-r-10"><input type="radio" name="Freight[is_free]" value="1" checked> 卖家承担运费</label></div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <div class="form-control-box">
                                ...
                                <input type="hidden" name="Freight[valuation]" value=""><div id="freight-valuation" class="" name="Freight[valuation]"><label class="control-label cur-p m-r-10"><input type="radio" name="Freight[valuation]" value="0" checked> 件数</label></div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <div class="form-control-box">
                                ...
                                <input type="hidden" name="Freight[limit_sale]" value="0"><div id="freight-limit_sale" class="" name="Freight[limit_sale]"><label class="control-label cur-p m-r-10"><input type="radio" name="Freight[limit_sale]" value="0" checked> 不支持</label>
                                    <label class="control-label cur-p m-r-10"><input type="radio" name="Freight[limit_sale]" value="1"> 支持</label></div>
                ...
                <div id="record_container">
                    ...
                    <div class="simple-form-field" >
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                    ...
                                    <div class="postage-detail freight-container" style="width: 780px;">
                                        <div class="entity">
                                            ...
                                            <div id="default_record" class="default" style="width: 100%; height: 30px; display: ;">
                                                <input type="hidden" id="freightrecord-is_default" class="form-control small sm-height pull-none" name="FreightRecord[is_default]" value="1">
                                                <div style="float: left;">
                                                    默认运费：

                                                    <input type="text" id="freightrecord-start_num" class="form-control small sm-height pull-none start-num" name="FreightRecord[start_num]" value="1.0">

                                                    <span class="unit_mark">件</span>
                                                    内，

                                                    <input type="text" id="freightrecord-start_money" class="form-control small sm-height pull-none start-money" name="FreightRecord[start_money]" value="0.00">

                                                    元， 每增加

                                                    <input type="text" id="freightrecord-plus_num" class="form-control small sm-height pull-none plus-num" name="FreightRecord[plus_num]" value="1.0">

                                                    <span class="unit_mark">件</span>
                                                    ， 增加运费

                                                    <input type="text" id="freightrecord-plus_money" class="form-control small sm-height pull-none plus-money" name="FreightRecord[plus_money]" value="0.00">

                                                    元，

                                                    <input type="hidden" name="FreightRecord[is_cash]" value="0"><label><input type="checkbox" id="freightrecord-is_cash" class="cur-p" name="FreightRecord[is_cash]" value="1"> 支持货到付款</label>
                                                </div>
								...
								<input type="text" id="freightrecord-cash_more" class="form-control small sm-height pull-none" name="FreightRecord[cash_more]" value="0.00">
								...
								元
                                            ...
                                            <div class="freight-set m-t-10">
                                                <div class="table-responsive">
                                                    <table id="freight_table" class="table table-hover">
                                                        ...
                                                        <tr>
                                                            <td>
                                                                ...
                                                                <input type="hidden" id="freightrecord-region_codes" class="region-codes" name="FreightRecord[region_codes]" value="11|12|13|14|15|21|22|23|31|32|33|34|35|36|37|41|42|43|44|45|46|50|51|52|53|54|61|62|63|81|82">

                                                                <input type="hidden" id="freightrecord-region_names" class="region-names" name="FreightRecord[region_names]" value="北京市|天津市|河北省|山西省|内蒙古自治区|辽宁省|吉林省|黑龙江省|上海市|江苏省|浙江省|安徽省|福建省|江西省|山东省|河南省|湖北省|湖南省|广东省|广西壮族自治区|海南省|重庆市|四川省|贵州省|云南省|西藏自治区|陕西省|甘肃省|青海省|香港特别行政区|澳门特别行政区">
                                                                <div class="area-group region-names-label" title="北京市|天津市|河北省|山西省|内蒙古自治区|辽宁省|吉林省|黑龙江省|上海市|江苏省|浙江省|安徽省|福建省|江西省|山东省|河南省|湖北省|湖南省|广东省|广西壮族自治区|海南省|重庆市|四川省|贵州省|云南省|西藏自治区|陕西省|甘肃省|青海省|香港特别行政区|澳门特别行政区">
                                                            ...
                                                            <td><input type="text" id="freightrecord-start_num" class="form-control small sm-height pull-none start-num" name="FreightRecord[start_num]" value="1.0"></td>
                                                            <td><input type="text" id="freightrecord-start_money" class="form-control small sm-height pull-none start-money" name="FreightRecord[start_money]" value="0.00"></td>
                                                            <td><input type="text" id="freightrecord-plus_num" class="form-control small sm-height pull-none plus-num" name="FreightRecord[plus_num]" value="1.0"></td>
                                                            <td><input type="text" id="freightrecord-plus_money" class="form-control small sm-height pull-none plus-money" name="FreightRecord[plus_money]" value="0.00"></td>
                                                            <td>
                                                                <input type="hidden" name="FreightRecord[is_cash]" value="0"><label><input type="checkbox" id="freightrecord-is_cash" class="cur-p" name="FreightRecord[is_cash]" value="1"> 支持</label>
													...
													<input type="text" id="freightrecord-cash_more" class="form-control small sm-height pull-none m-r-5" name="FreightRecord[cash_more]" value="0.00">
                    ...
                    <div id="free_container" style='display: none;'>
                        <!-- 区域限售 -->
                        <div class="simple-form-field" >
                            <div class="form-group">
                                <label for="" class="col-sm-3 control-label">
                                ...
                                <div class="col-sm-9">
                                    <div class="form-control-box">
                                        ...
                                        <input type="hidden" name="Freight[free_set]" value="0"><div id="freight-free_set" class="is-free-condition" name="Freight[free_set]" value="1" selection="0"><label class="control-label cur-p m-r-10"><input type="radio" name="Freight[free_set]" value="1"> 是</label>
                                            <label class="control-label cur-p m-r-10"><input type="radio" name="Freight[free_set]" value="0" checked> 否</label></div>
                                        ...
                                        <!--是否包邮弹框 star-->
                                        <div class="free-shipping free-container"style="width: 770px; display: none;">
                                            <div class="table-responsive">
