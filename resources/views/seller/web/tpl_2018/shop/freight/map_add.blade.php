    ...
    <div class="table-content m-t-30">
        <div class="content">
            ...
            <form id="form1" class="form-horizontal" name="Freight" action="/shop/freight/map-add" method="post" left="col-sm-3" right="col-sm-9">
                ...
                <!-- 模板类型 -->
                <input type="hidden" id="freight-freight_type" class="form-control" name="Freight[freight_type]" value="1">
                <!-- 模板名称  -->
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <div class="form-control-box">
                                ...
                                <input type="text" id="freight-title" class="form-control" name="Freight[title]">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <div class="form-control-box">
                                ...
                                <input type="hidden" id="freight-region_code" class="form-control" name="Freight[region_code]">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <div class="form-control-box">
                                ...
                                <input type="hidden" name="Freight[is_free]" value="0"><div id="freight-is_free" class="" name="Freight[is_free]"><label class="control-label cur-p m-r-10"><input type="radio" name="Freight[is_free]" value="0" checked> 自定义运费</label>
                                    <label class="control-label cur-p m-r-10"><input type="radio" name="Freight[is_free]" value="1"> 卖家承担运费</label></div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <div class="form-control-box">
                                ...
                                <input type="hidden" name="Freight[valuation]" value=""><div id="freight-valuation" class="" name="Freight[valuation]"><label class="control-label cur-p m-r-10"><input type="radio" name="Freight[valuation]" value="0" checked> 件数</label>
                                    <label class="control-label cur-p m-r-10"><input type="radio" name="Freight[valuation]" value="1"> 重量</label>
                                    <label class="control-label cur-p m-r-10"><input type="radio" name="Freight[valuation]" value="2"> 体积</label></div>
                    ...
                    <div class="simple-form-field" >
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
								...
								<input type="text" id="freightrecord-cash_more" class="form-control small sm-height pull-none" name="FreightRecord[cash_more]" value="0">
                ...
                <div class="simple-form-field" >
                    <div class="form-group">
                        <label for="" class="col-sm-4 control-label">
                            ...
                            <span class="ng-binding">配送范围：</span>
                        </label>
                        <div class="col-sm-8">
                            <div class="form-control-box">
                                ...
                                <div id="mapContainer" class="amap-container">
                                    <div class="amap-fixed-box">
                                        ...
                                        <div class="amap-fixed-info freight-records-edit" style="width: 220px;">
                                            ...
                                            <!-- 确定按钮 -->
                                            <a id="btn_ok" class="btn btn-primary btn-save pull-right m-t-10 m-r-10" href="javascript:;" style="display: none;">确定</a>
    ...
    <script type="text/javascript">
        function mapToggle() {
            if ($('.amap-container').hasClass('toggle')) {
                ...
                $(".amap-fixed-info").css("width", '320px');
