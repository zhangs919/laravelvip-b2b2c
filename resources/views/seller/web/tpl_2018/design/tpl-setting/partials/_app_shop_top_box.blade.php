@if(shopconf('app_shop_header_style', false, $shop_info['shop']['shop_id']) == 0)
    {{--店铺头部样式 app_shop_header_style=0--}}
...
@else
    {{--店铺头部样式 app_shop_header_style=1--}}
    <div class="shop-top-box shop-top-con2">
        ...
        <div class="shop-info">
            ...
            <h3 class="shop-name">{{ $shop_info['shop']['shop_name'] }}</h3>
            <div class="operate-box">
                <a class="btn invitation-open-shop SZY-SHOP-IS-COLLENT" href="javascript:void(0)" data-shop_id="{{ $shop_info['shop']['shop_id'] }}">
                    <em></em>
                    <span>关注</span>
                </a>
