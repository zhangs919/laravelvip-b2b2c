...
@section('content')
    ...
    <!-- 公共css -->
    <link rel="stylesheet" href="http://{{ config('lrw.frontend_domain') }}/css/common.css?v=20180702"/>
    <link rel="stylesheet" href="http://{{ config('lrw.frontend_domain') }}/css/shop_index.css?v=20180702"/>
    <link rel="stylesheet" href="http://{{ config('lrw.frontend_domain') }}/css/topic_activity.css?v=20180702"/>
    <link rel="stylesheet" href="http://{{ config('lrw.frontend_domain') }}/css/template.css?v=20180702"/>
    <link rel="stylesheet" href="http://{{ config('lrw.frontend_domain') }}/css/color-style.css?v=20180702"/>
    ...
    <div class="module-main unfold template-one" style="padding-bottom: 100px;">
        ...
        <div id="NAVIGATIONTPL">
            <!-- 引入头部 -->
            <!-- 引入头部文件 -->
            <script src="http://{{ config('lrw.frontend_domain') }}/js/index.js?v=20180813"></script>
            <script src="http://{{ config('lrw.frontend_domain') }}/js/tabs.js?v=20180813"></script>
            <script src="http://{{ config('lrw.frontend_domain') }}/js/bubbleup.js?v=20180813"></script>
            <script src="http://{{ config('lrw.frontend_domain') }}/js/jquery.hiSlider.js?v=20180813"></script>
            <script src="http://{{ config('lrw.frontend_domain') }}/js/index_tab.js?v=20180813"></script>
            <script src="http://{{ config('lrw.frontend_domain') }}/js/jump.js?v=20180813"></script>
            <script src="http://{{ config('lrw.frontend_domain') }}/js/nav.js?v=20180813"></script>
