...
@section('header_css')
    ...
    <link href="http://{{ config('lrw.mobile_domain') }}/css/iconfont/iconfont.css?v=202010121" rel="stylesheet">
            ...
            <div class="design_right_box">
                ...
                <div class="design_right_body">
                    ...
                    <div class="template_select design_right_child" style="display: none">
                        <li class="SZY-THEME-TPL " data-id="148" data-img="http://image.laravelvip.com/images/site/1/images/2023/12/29/17038424665244.png">
                        <span class="template_select_bg">
                            <img src="http://image.laravelvip.com/images/site/1/images/2023/12/29/17038424665244.png">
                        </span>
...
@section('footer_script')
    ...
    <script src="/assets/d2eace91/js/jquery.design.js?v=1"></script>
    <script src="/assets/d2eace91/js/design/TouchSlide.1.1.js?v=20201016"></script>
    <script src="/assets/d2eace91/js/design/tplsetting_mobile.js?v=1"></script>
