...
@section('content')
    ...
    <script src="/assets/d2eace91/js/design/bubbleup.js?v=20180710"></script>
    <script src="/assets/d2eace91/js/design/index_tab.js?v=20180710"></script>
    <script src="/assets/d2eace91/js/design/jump.js?v=20180710"></script>
    <script src="/assets/d2eace91/js/design/common.js?v=20180710"></script>
    <!--选色插件-->
    <link rel="stylesheet" href="/assets/d2eace91/bootstrap/evol-colorpicker/css/evol.colorpicker.css?v=20180702"/>
    <script src="/assets/d2eace91/js/jquery-ui.js?v=20180710"></script>
    <script src="/assets/d2eace91/bootstrap/evol-colorpicker/js/evol.colorpicker.js?v=20180710"></script>
    ...
    <div class="module-main unfold template-one"  style="padding-bottom:100px;">
        ...
        <div class="SZY-TPL-HEADER">
                ...
                <div class="w1210 clearfix">
                    ...
                    <div class="shop-info">
                        <div class="shop">
                            ...
                            <p>
                                <img src="http://images.68mall.com/system/credit/2016/06/07/14653016855399.gif" title="四星" />
                            </p>
                        ...
                        <div class="extra-info">
                            <div class="hd">
                                <p class="shop-collect">
                                    ...
                                    <a href="javascript:void(0);" onClick="toggleShop('{{ $shop_info->shop_id }}',this)" class="collect-btn bg-color">收藏本店</a>
                                </p>
                                ...
                                <p class="shop-qr-code">
                                    <img src="http://images.68mall.com/15164/gqrcode/shop/C4/qrcode_1.png" alt="店铺二维码" />
                                </p>
                                <!-- 店铺二维码 end -->
                            </div>
                            <div class="bd">
                                    ...
                                    <ul>
                                        <li>
                                            ...
                                            <a target="_blank" href="javascript:void(0);">
                                                <em class="count color" title="">4.52</em>
                                            </a>
                                        </li>
                                        <li>
                                            服务态度：
                                            <a target="_blank" href="javascript:void(0);">
                                                <em class="count color" title="">3.33</em>
                                            </a>
                                        </li>
                                        <li>
                                            发货速度：
                                    ...
                                    <ul>
                                        <li>
                                            ...
                                            <div class="extend-right">
                                                <a href="{{ route('pc_shop_home', ['shop_id'=>$shop_info->shop_id]) }}" class="color">{{ $shop_info->shop_name }}</a>
                                            </div>
                                        </li>
                                        ...
                                        <li class="locus">
                                            <label>所在地：</label>
                                            <div class="extend-right">
                                                <span>北京市 北京市 西城区西长安街街道国家电网充电站(国家大剧院)国家大剧院</span>
                                            </div>
                                        </li>
                    ...
                    <div class="search">
                        ...
                        <ul class="hot-query">
                            ...
                            <li class="first">
                                <a href="/search.html?keyword=硝苯地平" title="硝苯地平">硝苯地平</a>
                            </li>
            ...
            <div class="layout">
                ...
                <div class="shop-menu" @if(!empty(shopconf('nav_bgcolor', false, $shop_info->shop_id))) style='background-color:{{ shopconf('nav_bgcolor', false, $shop_info->shop_id) }};' @endif>
                    <div class="shop-menu-box">
                        <ul class="shop-menu-left">
                            <li>
                                <a href="{{ route('pc_shop_home', ['shop_id' => $shop_info->shop_id]) }}" target="">首页</a>
                            </li>
                            <li class="all-category">
                                <a href="{{ route('pc_shop_goods_list', ['filter_str' => $shop_info->shop_id]) }}" target="">
                                    全部分类
                                ...
                                <div class="all-category-coupon">
                                    ...
                                    <dl>
                                        <dt>
                                            <a href="{{ route('pc_shop_goods_list', ['filter_str' => $shop_info->shop_id.'-0']) }}" target="_blank">全部商品 ></a>
                                        </dt>
                                        <dd>
                                            <ul>
                                    ...
                                    @foreach($shop_category_list as $v)
                                        <dl>
                                        <dt>
                                            <a href="{{ route('pc_shop_goods_list', ['filter_str' => $shop_info->shop_id.'-'.$v['cat_id']]) }}" target="_blank">{{ $v['cat_name'] }} ></a>
                                        </dt>
                                        <dd>
                                            <ul>
                                                ...
                                                @if(!empty($v['_child']))
                                                    @foreach($v['_child'] as $child)
                                                        <li>
                                                            <a href="{{ route('pc_shop_goods_list', ['filter_str' => $shop_info->shop_id.'-'.$child['cat_id']]) }}" target="_blank">{{ $child['cat_name'] }}</a>
                                                        </li>
                                                    @endforeach
                                                @endif
                        ...
                        <ul class="shop-menu-right">
                            ...
                            <li class="shop-nav">
                                ...
                                <a href="javascript:void(0)">{{ $v->nav_name }}</a>
            ...
            <script type='text/javascript'>
                ...
                function search_me() {
                    document.getElementById('search-form').action = "{{ route('pc_shop_search', ['shop_id' => $shop_info->shop_id]) }}";
                    document.getElementById("search-form").submit();
                }
    ...
    <div class="panelIconContainer">
        <div class="floatPanelIconBox ">
            ...
            <a class="floatPanel_setSiteStyle SZY-SITE-STYLE hide"><i></i><span>样式</span></a>
        </div>
    ...
    <script src="/assets/d2eace91/js/design/tplsetting.js?v=20180710"></script>
    <script type="text/javascript">
        //初始化数据
        var chk_value =[];
        var data = [];
