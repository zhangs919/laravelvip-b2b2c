...
@section('header_css')
    <link href="http://{{ config('lrw.frontend_domain') }}/css/common.css?v=20201012" rel="stylesheet">
    <link href="http://{{ config('lrw.frontend_domain') }}/css/shop_index.css?v=20201012" rel="stylesheet">
    <link href="http://{{ config('lrw.frontend_domain') }}/css/template.css?v=20201012" rel="stylesheet">
...
@section('footer_script')
    ...
    <script src="http://{{ config('lrw.frontend_domain') }}/js/app.frontend.index.min.js?v=20201016"></script>
