...
@section('content')
    ...
    <!--顶部topbar-->
    <style>
        .layout .shop-menu ul.shop-menu-right:hover {
        ...
        <div class="module-topBar-inner">
            ...
            <div class="topBar-navbar-r">
                <div class="top-set-btn displayMode">
                    ...
                    <a href="/design/tpl-setting/setup?page=app_topic&topic_id={{ $topic_id }}" class="set-btn" title="APP装修">
                    ...
                    <div class="panelItemContainer">
                        ...
                        <div class="panelItemContent">
                            <ul>
                                ...
                                <li class="drag ui-draggable" id="0" data-code="hots_pot">
                                    <a class="panelModuleIcon" href="javascript:void(0);">
...
@section('footer_script')
    ...
    <script src="/assets/d2eace91/js/swiper/swiper.jquery.min.js?v=202003261806"></script>
    ...
    <script src="/assets/d2eace91/js/jquery.design.js?v=202003261806"></script>
    <script src="/assets/d2eace91/js/design/TouchSlide.1.1.js?v=202003261806"></script>
    <script src="/assets/d2eace91/js/design/shop_index.js?v=202003261806"></script>
    <script src="/assets/d2eace91/js/design/bubbleup.js?v=202003261806"></script>
    <script src="/assets/d2eace91/js/design/index_tab.js?v=202003261806"></script>
    ...
    <script src="/assets/d2eace91/js/jquery.base64.js?v=202003261806"></script>
    <script src="/assets/d2eace91/js/editor/kindeditor-all.min.js?v=202003261806"></script>
    <script src="/assets/d2eace91/js/editor/lang/zh_CN.js?v=202003261806"></script>
    <script>
        function search_all() {
