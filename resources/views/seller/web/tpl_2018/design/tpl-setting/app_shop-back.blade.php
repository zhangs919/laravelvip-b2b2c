...
@section('content')
    ...
    <!-- 装修js -->
    <link rel="stylesheet" href="/assets/d2eace91/css/design/mobile/design.css?v=20190422"/>
    <link rel="stylesheet" href="/assets/d2eace91/css/design/mobile/tplsetting.css?v=20190422"/>
    <link rel="stylesheet" href="/assets/d2eace91/css/design/mobile/swiper.min.css?v=20190422"/>
    <script src="/assets/d2eace91/js/design/swiper.jquery.min.js?v=201902541"></script>
    <!--前台css-->
    <link rel="stylesheet" href="/assets/d2eace91/css/design/mobile/public.css?v=20190422"/>
    <link rel="stylesheet" href="http://m.test.xxxx.com/css/dianpu.css?v=20190422"/>
    <link rel="stylesheet" href="http://m.test.xxxx.com/css/shop_header.css?v=20190422"/>
    ...
    <div class="module-topBar">
        ...
        <div class="module-topBar-inner">
            ...
            <div class="topBar-navbar hide">
                <a class="SZY-SITE-STYLE" href="javascript:void(0);" data-group="app_shop_style">
            ...
            <div class="mobile_list">
                ...
                <div class="special-item">
                    ...
                    <div class="SZY-SHOP-HEADER">
                        <a href="javascript:void(0)" class="SZY-SET-HEAD shop-header-selector content-selector" title="编辑" data-url='/shop/config/index.html?group=app_shop_header' data-title='店铺头部设置'></a>
                        {{--引入店铺头部--}}
                        @include('design.tpl-setting.partials._app_shop_top_box')
                    ...
                    <div class="template_select design_right_child" style="display: none">
                        ...
                        @if(!empty($theme_list))
                            @foreach($theme_list as $theme)
                                <li class="SZY-THEME-TPL @if(@$app_theme_id == $theme['back_id']){{ 'current' }}@endif" data-id="{{ $theme['back_id'] }}" data-img="{{ $theme['img'] }}">
    ...
    <script src="/assets/d2eace91/js/validate/jquery.validate.custom.js?v=201902541"></script> <script src="/assets/d2eace91/js/jquery.widget.js?v=201902541"></script> <script src="/assets/d2eace91/js/design/tplsetting_mobile.js?v=201902541"></script>
