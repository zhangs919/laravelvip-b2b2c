                ...
                <div class="special-item">
                    ...
                    <div class="SZY-TPL-FOOTER footer-nav-box"><!--底部菜单 start-->
                        ...
                        <div class="footer-nav">
                            <a href="javascript:void(0)" class="content-selector SZY-TPL-SETTING" data-url='/design/navigation/list?nav_page=m_topic{{ $topic_id }}&nav_position=3' data-title='导航设置' data-tpl='@frontend/web_mobile/modules/library/topic_footer_menu.tpl' data-container='.SZY-TPL-FOOTER'>
