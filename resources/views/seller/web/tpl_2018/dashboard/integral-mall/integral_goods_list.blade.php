...
@section('style')
    ...
    <script src="/assets/d2eace91/js/bootstrap3-editable/js/bootstrap-editable.js?v=20180027"></script>
...
@section('content')
    ...
    <div class="search-term  m-b-10">
        <form id="searchForm" action="/dashboard/integral-mall/integral-goods-list" method="GET">
