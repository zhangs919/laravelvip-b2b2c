...
@section('content')
    ...
    <div class="search-term m-b-10">
        <form id="searchForm" action="/dashboard/goods-mix/list" method="GET">
            <div class="simple-form-field">
                <div class="form-group">
                    ...
                    <div class="form-control-wrap">
                        ...
                        <input type="text" name="act_name" class="form-control" value="" placeholder="请输入套餐名字" />
                    </div>
                </div>
            </div>
    ...
    <div class="table-responsive">
        ...
        {{--引入列表--}}
        @include('dashboard.goods-mix.partials._list')
    </div>
        ...
        $().ready(function() {
            ...
            $("body").on("click", ".delete-goods", function() {
                ...
                $.confirm("您确定要删除此商品吗？", function() {
                    $.post('/dashboard/goods-mix/batch-delete', {
                        ids: ids
                    }, function(result) {
                        if (result.code == 0) {
                            $.msg(result.message);
