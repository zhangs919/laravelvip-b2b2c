                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <div class="form-control-box">
                                ...
                                <input type="text" id="goodsmixmodel-act_price" class="form-control ipt m-r-10 act_price" name="GoodsMixModel[act_price]" value="{{ $model['act_price'] }}" readonly="readonly">元
...
<table id="table_list" class="table table-hover m-b-0 goods-mix-list">
	...
	<tbody id="goods_info">
		...
		<tr data-goods-mix-sku-id="872" data-goods-mix-goods-id="178">
			...
			<td>
				<a class="btn btn-warning btn-sm show-sku" data-goods-id="178">设置参与套餐规格</a>
			</td>

			<td class="handle">
				<a href="javascript:void(0);" data-sku-id="872" data-goods-id="178" data-goods-price="￥1.00-￥2.00" class="del border-none">删除</a>
			</td>
		</tr>
		...
		<tr data-goods-mix-sku-id="832" data-goods-mix-goods-id="167">
			...
			<td>
				<a class="btn btn-warning btn-sm show-sku" data-goods-id="167">设置参与套餐规格</a>
			</td>

			<td class="handle">
				<a href="javascript:void(0);" data-sku-id="832" data-goods-id="167" data-goods-price="119.90" class="del border-none">删除</a>
			</td>
		</tr>
...
<input type="text" id="goodsmixmodel-act_price" class="form-control ipt m-r-10 act_price" name="GoodsMixModel[act_price]" value="100">元</script>
