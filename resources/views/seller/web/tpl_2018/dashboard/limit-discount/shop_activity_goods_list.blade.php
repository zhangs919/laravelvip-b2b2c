...
@section('content')
    ...
    <div class="search-term m-b-10">
        <form id="searchForm" action="/dashboard/limit-discount/shop-activity-goods-list" method="GET">
            <input type="hidden" name="act_id" value="17">
            <input type="hidden" name="keyword_type" value="goods_name">
            ...
            <input type="hidden" name="showloading" value="true">
    ...
    <div class="table-responsive" style="overflow: visible !important;">
        {{--引入列表--}}
        @include('dashboard.limit-discount.partials._shop_activity_goods_list')
    </div>
