<table id="table_list" class="table table-hover">
    ...
    <tr>
        ...
        <th class="text-c w120" data-sortname="act_price">活动价（元）</th>
    ...
    <tr>
        ...
        <td class="f13">
            ...
            <div class="ng-binding goods-message w180">
                <div class="name">
                    <a href="javascript:;" class="goods_name" title="{{ $item->goods_name }}">{{ $item->goods_name }}</a>
                </div>
                <div class="pull-left">
        ...
        <td class="text-c">{!! $item->act_price_format !!}</td>
