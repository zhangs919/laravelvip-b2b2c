        ...
        <div class="table-content m-t-30 clearfix">
            <div class="simple-form-field">
                <div class="form-group form-group-showcase">
                    ...
                    <div class="col-sm-9">
                        <p class="f16" id="activity_type">到店送红包</p>
                        <p class="help-block-t">用户主动领取，领取的场景是：手机或PC端的商品详情页、购物车、红包集市、手机端的店铺红包列表</p>
                    </div>
                </div>
            </div>
            <div class="form-horizontal m-t-30">
                ...
                <div class="simple-form-field" >
                    <div class="form-group">
                        <label for="bonus-receive_count" class="col-sm-3 control-label">
                            <span class="text-danger ng-binding">*</span>
                            <span class="ng-binding">每人限领数量：</span>
                        </label>
                        <div class="col-sm-9">
                            <div class="form-control-box">

                                <input type="text" id="bonus-receive_count" class="form-control ipt m-r-10" name="Bonus[receive_count]" value="1">
                                <span>张</span>


                            </div>

                            <div class="help-block help-block-t"><div class="help-block help-block-t">用于限制每个会员领取此红包的数量，最小值为“1”</div></div>
                        </div>
                    </div>
                </div>
                ...
                <div class="simple-form-field" >
                    <div class="form-group">
                        <label for="bonus-sort" class="col-sm-4 control-label">
                            <span class="text-danger ng-binding">*</span>
                        ...
                        <div class="col-sm-8">
                            <div class="form-control-box">
                                ...
                                <input type="text" id="bonus-sort" class="form-control small" name="Bonus[sort]" value="255">


                            </div>

                            <div class="help-block help-block-t"><div class="help-block help-block-t">数字范围为0~255，数字越小越靠前，控制红包在领红包页面的展示顺序</div></div>
                        </div>
                    </div>
                </div>
                <!-- 其他信息 -->
...
[{"id": "bonus-shop_id", "name": "Bonus[shop_id]", "attribute": "shop_id", "rules": {"required":true,"messages":{"required":"店铺编号不能为空。"}}},{"id": "bonus-bonus_name", "name": "Bonus[bonus_name]", "attribute": "bonus_name", "rules": {"required":true,"messages":{"required":"红包名称不能为空。"}}},{"id": "bonus-bonus_amount", "name": "Bonus[bonus_amount]", "attribute": "bonus_amount", "rules": {"required":true,"messages":{"required":"红包面值不能为空。"}}},{"id": "bonus-receive_count", "name": "Bonus[receive_count]", "attribute": "receive_count", "rules": {"required":true,"messages":{"required":"每人限领数量不能为空。"}}},{"id": "bonus-bonus_number", "name": "Bonus[bonus_number]", "attribute": "bonus_number", "rules": {"required":true,"messages":{"required":"红包发放数量不能为空。"}}},{"id": "bonus-bonus_type", "name": "Bonus[bonus_type]", "attribute": "bonus_type", "rules": {"required":true,"messages":{"required":"红包类型不能为空。"}}},{"id": "bonus-use_range", "name": "Bonus[use_range]", "attribute": "use_range", "rules": {"required":true,"messages":{"required":"使用范围不能为空。"}}},{"id": "bonus-start_time", "name": "Bonus[start_time]", "attribute": "start_time", "rules": {"required":true,"messages":{"required":"红包有效起始时间不能为空。"}}},{"id": "bonus-end_time", "name": "Bonus[end_time]", "attribute": "end_time", "rules": {"required":true,"messages":{"required":"红包有效截至时间不能为空。"}}},{"id": "bonus-is_enable", "name": "Bonus[is_enable]", "attribute": "is_enable", "rules": {"required":true,"messages":{"required":"是否有效不能为空。"}}},{"id": "bonus-is_delete", "name": "Bonus[is_delete]", "attribute": "is_delete", "rules": {"required":true,"messages":{"required":"是否删除不能为空。"}}},{"id": "bonus-min_goods_amount", "name": "Bonus[min_goods_amount]", "attribute": "min_goods_amount", "rules": {"required":true,"messages":{"required":"最小订单金额限制不能为空。"}}},{"id": "bonus-add_time", "name": "Bonus[add_time]", "attribute": "add_time", "rules": {"required":true,"messages":{"required":"红包添加时间不能为空。"}}},{"id": "bonus-sort", "name": "Bonus[sort]", "attribute": "sort", "rules": {"required":true,"messages":{"required":"排序不能为空。"}}},{"id": "bonus-shop_id", "name": "Bonus[shop_id]", "attribute": "shop_id", "rules": {"integer":{"pattern":"/^\\s*[+-]?\\d+\\s*$/"},"messages":{"integer":"店铺编号必须是整数。"}}},{"id": "bonus-receive_count", "name": "Bonus[receive_count]", "attribute": "receive_count", "rules": {"integer":{"pattern":"/^\\s*[+-]?\\d+\\s*$/"},"messages":{"integer":"每人限领数量必须是整数。"}}},{"id": "bonus-bonus_number", "name": "Bonus[bonus_number]", "attribute": "bonus_number", "rules": {"integer":{"pattern":"/^\\s*[+-]?\\d+\\s*$/"},"messages":{"integer":"红包发放数量必须是整数。"}}},{"id": "bonus-bonus_type", "name": "Bonus[bonus_type]", "attribute": "bonus_type", "rules": {"integer":{"pattern":"/^\\s*[+-]?\\d+\\s*$/"},"messages":{"integer":"红包类型必须是整数。"}}},{"id": "bonus-is_enable", "name": "Bonus[is_enable]", "attribute": "is_enable", "rules": {"integer":{"pattern":"/^\\s*[+-]?\\d+\\s*$/"},"messages":{"integer":"是否有效必须是整数。"}}},{"id": "bonus-is_delete", "name": "Bonus[is_delete]", "attribute": "is_delete", "rules": {"integer":{"pattern":"/^\\s*[+-]?\\d+\\s*$/"},"messages":{"integer":"是否删除必须是整数。"}}},{"id": "bonus-sort", "name": "Bonus[sort]", "attribute": "sort", "rules": {"integer":{"pattern":"/^\\s*[+-]?\\d+\\s*$/"},"messages":{"integer":"排序必须是整数。"}}},{"id": "bonus-bonus_data", "name": "Bonus[bonus_data]", "attribute": "bonus_data", "rules": {"string":true,"messages":{"string":"红包扩展数据必须是一条字符串。"}}},{"id": "bonus-bonus_name", "name": "Bonus[bonus_name]", "attribute": "bonus_name", "rules": {"string":true,"messages":{"string":"红包名称必须是一条字符串。","maxlength":"红包名称只能包含至多30个字符。"},"maxlength":30}},{"id": "bonus-bonus_desc", "name": "Bonus[bonus_desc]", "attribute": "bonus_desc", "rules": {"string":true,"messages":{"string":"红包描述必须是一条字符串。","maxlength":"红包描述只能包含至多255个字符。"},"maxlength":255}},{"id": "bonus-bonus_image", "name": "Bonus[bonus_image]", "attribute": "bonus_image", "rules": {"string":true,"messages":{"string":"红包图片必须是一条字符串。","maxlength":"红包图片只能包含至多255个字符。"},"maxlength":255}},{"id": "bonus-sort", "name": "Bonus[sort]", "attribute": "sort", "rules": {"integer":{"pattern":"/^\\s*[+-]?\\d+\\s*$/"},"messages":{"integer":"排序必须是整数。","min":"排序必须不小于0。","max":"排序必须不大于255。"},"min":0,"max":255}},{"id": "bonus-bonus_amount", "name": "Bonus[bonus_amount]", "attribute": "bonus_amount", "rules": {"number":{"pattern":"/^\\s*[-+]?[0-9]*\\.?[0-9]+([eE][-+]?[0-9]+)?\\s*$/"},"messages":{"number":"红包面值必须是一个数字。","decimal":"红包面值必须是一个不大于2位小数的数字。","min":"红包面值必须不小于0.01。"},"decimal":2,"min":0.01}},{"id": "bonus-receive_count", "name": "Bonus[receive_count]", "attribute": "receive_count", "rules": {"integer":{"pattern":"/^\\s*[+-]?\\d+\\s*$/"},"messages":{"integer":"每人限领数量必须是整数。","min":"每人限领数量必须不小于1。"},"min":1}},{"id": "bonus-bonus_number", "name": "Bonus[bonus_number]", "attribute": "bonus_number", "rules": {"integer":{"pattern":"/^\\s*[+-]?\\d+\\s*$/"},"messages":{"integer":"红包发放数量必须是整数。","min":"红包发放数量必须不小于1。"},"min":1}},{"id": "bonus-min_goods_amount", "name": "Bonus[min_goods_amount]", "attribute": "min_goods_amount", "rules": {"number":{"pattern":"/^\\s*[-+]?[0-9]*\\.?[0-9]+([eE][-+]?[0-9]+)?\\s*$/"},"messages":{"number":"最小订单金额限制必须是一个数字。","min":"最小订单金额限制必须不小于0。"},"min":0}},{"id": "bonus-min_goods_amount", "name": "Bonus[min_goods_amount]", "attribute": "min_goods_amount", "rules": {"compare":{"operator":">=","type":"number","compareAttribute":"bonus-bonus_amount","skipOnEmpty":1},"messages":{"compare":"最小订单金额不能小于红包面值"}}},{"id": "bonus-is_original_price", "name": "Bonus[is_original_price]", "attribute": "is_original_price", "rules": {"in":{"range":["0","1"]},"messages":{"in":"仅限原价购买时使用是无效的。"}}},{"id": "bonus-start_time", "name": "Bonus[start_time]", "attribute": "start_time", "rules": {"compare":{"operator":"<","type":"date","compareAttribute":"bonus-end_time","skipOnEmpty":1},"messages":{"compare":"开始时间不能大于结束时间"}}},{"id": "bonus-end_time", "name": "Bonus[end_time]", "attribute": "end_time", "rules": {"compare":{"operator":">=","type":"date","compareAttribute":"bonus-start_time","skipOnEmpty":1},"messages":{"compare":"结束时间不能小于开始时间"}}},]
</script>
    <script type='text/javascript'>
        // 初始化验证器
