    ...
    <div class="pop-tab-content">
        <div class="pop-tab-pane selected">
            <div class="input-button-box m-b-10">
                <input class="p-input" value="http://{{ env('MOBILE_DOMAIN') }}/bonus-{{ $bonus_id }}" type="text">
                <a class="input-button" data-clipboard-text="http://{{ env('MOBILE_DOMAIN') }}/bonus-{{ $bonus_id }}">复制</a>
            </div>
        ...
        <div class="pop-tab-pane">
            <div class="input-button-box m-b-10">
                <input value="http://{{ env('MOBILE_DOMAIN') }}/bonus-{{ $bonus_id }}" type="text">
                <a class="input-button" data-clipboard-text="http://{{ env('MOBILE_DOMAIN') }}/bonus-{{ $bonus_id }}">复制</a>
            </div>
            <div class="qr-code-border qr-code-bg">
                <p class="shop-name">{{ $bonus_info->shop_name }}</p>
