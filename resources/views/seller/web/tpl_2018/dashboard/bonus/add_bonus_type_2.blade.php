...
@section('content')
    ...
    <form id="Bonus" class="form-horizontal" name="Bonus" action="/dashboard/bonus/add?bonus_type=2" method="post" enctype="multipart/form-data">
        @csrf
        <input type="hidden" id="bonus-bonus_id" class="form-control" name="Bonus[bonus_id]">

        <input type="hidden" id="bonus-bonus_type" class="form-control" name="Bonus[bonus_type]" value="2">
        <div class="table-content m-t-30 clearfix">
            <div class="simple-form-field">
                <div class="form-group form-group-showcase">
                    ...
                    <div class="col-sm-9">
                        <p class="f16" id="activity_type">收藏送红包</p>
                        <p class="help-block-t">系统自动派发，系统提醒用户获得红包：会员仅当首次收藏店铺时有效 收藏红包仅能创建一次，不可删除，您可以选择作废或者过期后重新创建该类型红包</p>
                    </div>
                </div>
            </div>
