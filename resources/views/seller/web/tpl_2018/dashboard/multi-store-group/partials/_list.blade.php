<table id="table_list" class="table table-hover">
    ...
    <tr>
        ...
        <td class="handle">
            ...
            <a href="javascript:void(0)" class="group_related_goods" data-groupid="{{ $v->group_id }}" data-groupname="aaaa" data-shopid="{{ $v->shop_id }}">关联商品</a>
            <a href="javascript:void(0)" class="set_store_act" data-groupid="{{ $v->group_id }}" data-groupname="aaaa">活动参与设置</a>
        </td>
    </tr>
    @endforeach
