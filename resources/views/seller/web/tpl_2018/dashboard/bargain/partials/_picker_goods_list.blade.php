        ...
        @if(!$list->isEmpty())
            @foreach($list as $v)
                <li class="sku-item">
                    ...
                    <input type="hidden" name="sku_name" value="{{ $v->goods_name }}" />
                    <input type="hidden" name="goods_name" value="{{ $v->goods_name }}" />
                    ...
                    <input type="hidden" name="sku_image" value="{{ get_image_url($v->goods_image) }}?x-oss-process=image/resize,m_pad,limit_0,h_80,w_80" />
                    ...
                    <dl>
                        ...
                        <dd class="date">
                            <p class="name">
                                <!-- 活动色块 -->
{{--                                <em class="act-type fight-group">拼团</em>--}}
