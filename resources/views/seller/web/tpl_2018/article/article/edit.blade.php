                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <div class="form-control-box">
                            ...
                            <input type="text" id="articlemodel-add_time" class="form-control form_datetime" name="ArticleModel[add_time]" value="{{ $info->add_time ?? date('Y-m-d H:i:s', time()) }}">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <div class="form-control-box">
                            ...
                            <!-- 文本编辑器 -->
                            <textarea id="content" class="form-control" name="ArticleModel[content]" rows="5" style="width:700px; height: 350px;">{!! $info->content !!}</textarea>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <div class="form-control-box">
                            ...
                            <input type="text" id="articlemodel-link" class="form-control" name="ArticleModel[link]" placeholder="http://" value="{{ $info->link }}">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <div class="form-control-box">
                            ...
                            <input type="text" id="articlemodel-sort" class="form-control small" name="ArticleModel[sort]" value="{{ $info->sort ?? '255' }}">
