...
@section('content')
    ...
    <div class="search-term m-b-10">
        <form id="searchForm" action="/statistics/goods-analyse/purchase-rate" method="GET">
    ...
    <div class="table-responsive">
        {{--引入列表--}}
        @include('statistics.goods-analyse.partials._purchase_rate')
    </div>
    ...
    <script>
        ...
        $().ready(function () {
            ...
            $("#btn_export").click(function () {
                var url = "/statistics/goods-analyse/purchase-rate-export";
