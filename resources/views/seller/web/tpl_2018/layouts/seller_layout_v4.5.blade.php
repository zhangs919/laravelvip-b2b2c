        ...
        <div class="site-nav-content">
            <div class="seller-logo">
                <a href="/shop/shop-set/edit"  title="[&nbsp;店铺&nbsp;]&nbsp;{{ $shop->shop_name ?? '' }}">
                    <img src="@if(!empty($shop->shop_image)){{ get_image_url($shop->shop_image) }}@endif" />
                </a>
            </div>
            ...
            <div class="user-info">
                ...
                <div class="user-dropdown">
                    ...
                    <div class="user-dropdown-select">
                        ...
                        <a  href='{{ route('pc_shop_home',['shop_id'=>@$shop->shop_id]) }}' target="_blank">前往店铺</a> <a href="http://{{ config('lrw.frontend_domain') }}/user/security/edit-password.html" >修改密码</a> <a  onClick="clearCache()">清除缓存</a> <a href="/site/logout" data-method="post" data-confirm="您确定要退出卖家中心吗？">安全退出</a> </div>
                </div>
            </div>
...
<div class="seller-center">
    ...
    <div id="message-box" class="notice-center">
        <div class="notice-nav">
            <a class="notice-nav-service" href="http://{{ config('lrw.kf_domain') }}/admin/login/witchAccount.html?url=xxxxxxxxxxxxxx" target='_blank'><span class="icon customer-service"></span>客服消息</a><a class="notice-nav-message"><span class="icon message-reminder"></span>消息<em id="message_logo" class="m-l-5" >{{ $messageCount ?? '' }}</em></a>
        </div>
...
<script type="text/javascript">
    ...
    {{--WS_AddUser({--}}
        {{--'user_id': 'shop_2',--}}
        {{--'url': "ws://{{ config('lrw.push_domain') }}:7272",--}}
        {{--'type': "add_user"--}}
    {{--});--}}
    //右下角消息提醒弹窗js
