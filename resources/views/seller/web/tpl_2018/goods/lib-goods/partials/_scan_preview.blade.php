<table id="table_list" class="table table-hover">
    ...
    <tr>
        ...
        <th class="w120" data-sortname="goods_barcode">商品条形码</th>
        <th class="text-c w150" data-sortname="goods_price">本店价（元）</th>
        <!-- <th class="text-c" data-sortname="goods_number">库存</th> -->
        <!-- <th data-sortname="goods_status">状态</th> -->
        <th class="w120" data-sortname="add_time">发布时间</th>
    ...
    <tr>
        ...
        <td colspan="7">
            <div class="pull-left">
                <input type="button" id="batch-delete" class="btn btn-danger m-r-2 del" value="取消导入" />
            </div>
