...
@section('content')
    ...
    <!--搜索-->
    <div class="search-term m-b-10"><form id="SearchModel" name="SearchModel" action="/goods/list/trash" method="POST">
            <input type="hidden" name="_csrf" value="OYV0KmP-mqWRRBhGtewaeLk2ShMlxWJlLocsngedxGhuyCwYGrPI8ugKS3_23ltJ034SYmqhKjV0tUPsV_SQCw==">
                ...
                <div class="form-group">
                    ...
                    <div class="form-control-wrap">
                        ...
                        <select id="searchmodel-cat_id" class="form-control chosen-select" name="cat_id" data-width="200">
                            ...
                            <option value="604"><span>◢</span>&nbsp;文学</option>
                            <option value="610">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span>◢</span>&nbsp;图书</option>
                            ...
                            <option value="16"><span>◢</span>&nbsp;2018</option>
                            <option value="21">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span>◢</span>&nbsp;5.22</option>
                ...
                <div class="form-group">
                    ...
                    <div class="form-control-wrap">
                        ...
                        <select id="searchmodel-scid" class="form-control chosen-select" name="scid" data-width="120">
                            ...
                            <option value="549"><span>◢</span>&nbsp;货品类型</option>
                            <option value="560">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;广货</option>
                            <option value="561">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;杭货</option>
                            <option value="562">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;欧货</option>
                            <option value="563">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;韩货</option>
                            <option value="552"><span>◢</span>&nbsp;月份波段</option>
                            <option value="553">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;2018.5月第二波段</option>
                            <option value="564">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;2018.5月第三波段</option>
                            <option value="565">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;2018.5月第四波段</option>
                            <option value="566">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;2018.6月第一波段</option>
                            <option value="567">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;2018.6月第二波段</option>
                            <option value="555"><span>◢</span>&nbsp;家饰家品</option>
                            <option value="568">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;灯具类</option>
                            <option value="569">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;挂饰摆件类</option>
                            <option value="570">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;置物架类</option>
                            <option value="571">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;椅子类</option>
                            <option value="572">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;桌子类</option>
                            <option value="573">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;柜子类</option>
                            <option value="574">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;餐具类</option>
                            <option value="575">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;香薰类</option>
                            <option value="576">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;小家电类</option>
                            <option value="577">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;家纺类</option>
                            <option value="578">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;收纳类</option>
                            <option value="556"><span>◢</span>&nbsp;女装</option>
                            <option value="558">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;半裙类</option>
                            <option value="583">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;连衣裙类</option>
                            <option value="584">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;T恤类</option>
                            <option value="585">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;长裤类</option>
                            <option value="586">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;短裤类</option>
                            <option value="587">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;衬衫类</option>
                            <option value="588">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;内搭类</option>
                            <option value="589">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;衬衫类</option>
                            <option value="590">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;外套类</option>
                            <option value="591">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;针织衫类</option>
                            <option value="592">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;打底衫类</option>
                            <option value="593">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;家居服类</option>
                            <option value="594">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;皮草类</option>
                            <option value="595">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;羽绒类</option>
                            <option value="596">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;棉衣类</option>
                            <option value="597">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;套装类</option>
                            <option value="598">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;皮衣类</option>
                            <option value="599">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;毛织类</option>
                            <option value="600">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;大衣类</option>
                            <option value="601">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;卫衣类</option>
                            <option value="557"><span>◢</span>&nbsp;美妆</option>
                            <option value="579">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;香皂手工皂</option>
                            <option value="580">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;化妆品类</option>
                            <option value="581">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;美妆工具</option>
                            <option value="582">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;洗护类</option>
                            <option value="602"><span>◢</span>&nbsp;服装配饰</option>
                            <option value="603">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;手套</option>
                            <option value="604">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;领带</option>
                            <option value="605">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;披肩</option>
                            <option value="606">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;斗篷</option>
                            <option value="607">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;腰封</option>
                            <option value="608">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;胸针</option>
                            <option value="609">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;皮带</option>
                            <option value="610">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;围巾</option>
                            <option value="611">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;袜子</option>
                            <option value="612">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;帽子</option>
                            <option value="613">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;眼镜</option>
                            <option value="614">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;戒指</option>
                            <option value="615">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;手链</option>
                            <option value="616">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;耳饰</option>
                            <option value="617">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;包包</option>
                            <option value="618">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;单鞋</option>
                            <option value="619">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;手表</option>
                            <option value="622"><span>◢</span>&nbsp;化药生物</option>
                            <option value="623">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;麻黄碱</option>
                        </select>
