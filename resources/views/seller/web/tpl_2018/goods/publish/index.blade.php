                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <div class="form-control-box">
                                    ...
                                    <input type="text" id="goodsmodel-goods_moq" class="form-control ipt pull-none m-r-10" name="GoodsModel[goods_moq]" value="1" data-anchor="最小起订量">
                    ...
                    <div class="simple-form-field">
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <div class="form-control-box">
                                    <!-- 图片相对路径 -->
                                    <input type="hidden" id="goodsmodel-cover_image" class="form-control" name="GoodsModel[cover_image]" value="">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <div class="form-control-box">
                                    ...
                                    <!-- 视频相对路径 -->
                                    <input type="hidden" id="goodsmodel-goods_video" class="form-control" name="GoodsModel[goods_video]">
                 ...
                 -->
                                    ...
                                    <div class="tab-content" data-anchor="商品详情">
                                        <div id="texpress1" class="tab-pane fade in active">
                                            <div class="form-control-box">
                                                <!-- 文本编辑器 -->
                                                <textarea id="pc_desc" class="form-control" name="GoodsModel[pc_desc]" rows="5" style="width:100%; height: 350px; visibility: hidden;"></textarea>
                                            </div>
                                        </div>
     ...
     -->
                ...
                <span class="user-information-item m-b-10 m-r-20 disp-inlblock">
                    ...
                    <a href="javascript:void(0)" class="btn btn-danger btn-sm m-l-5 del-information">移除</a>
                            ...
                            <!-- 时间插件引入 start -->
                            <link rel="stylesheet" href="/assets/d2eace91/bootstrap/datetimepicker/css/bootstrap-datetimepicker.css?v=4.0"/> <script src="/assets/d2eace91/bootstrap/datetimepicker/js/bootstrap-datetimepicker.js?v=20190110"></script>
                            <script src="/assets/d2eace91/bootstrap/datetimepicker/js/locales/bootstrap-datetimepicker.zh-CN.js?v=20190110"></script>
                            <!-- 时间插件引入 end -->
                            <script type="text/javascript">
...
@section('footer_script')
    <script>
        ...
        $(function(){
            ...
            // 初始选中的规格
            var init_checked_attr_ids = "".split(",");
            var init_checked_attr_vids = "".split(",");
        ...
        $().ready(function(){
            ...
            $('#goodsmodel-goods_mode').find('[name="GoodsModel[goods_mode]"]').change(function(){
                ...
                $.confirm("切换商品类别会丢失表单数据，您确定切换吗?", function() {
                    $.go('/goods/publish/index.html?cat_id={{ $cat_id }}&goods_mode='+goods_mode);
                },function(){
