...
@section('content')
    ...
    <div class="table-content m-t-30 clearfix">
        <form id="form1" class="form-horizontal" name="SelfPickup" action="/goods/self-pickup/add" method="POST">
            @csrf
            <!-- 隐藏域 -->
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <div id="form-control-box">
                            ...
                            <input type="hidden" id="region_code" name="SelfPickup[region_code]">
            ...
            <div class="simple-form-field" >
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        ...
                        <div class="help-block help-block-t"><div class="help-block help-block-t">在pc端自提点介绍页面、手机端商品详情页查看自提点列表，结算页面自提点选择弹框中，请填写正确的手机号或座机座机号格式：xxxx-xxxxxxx</div></div>
                    </div>
                </div>
            </div>
            <div class="simple-form-field">
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        ...
                        <span class="help-block help-block-t">显示在pc端自提点介绍页面，建议上传300*200像素的图片</span>
                    </div>
            ...
            <div class="simple-form-field" >
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                            ...
                            <label class="control-label control-label-switch">
                                <div class="switch bootstrap-switch bootstrap-switch-mini sm-nav-switch">
                                    ...
                                    @if(!isset($info->is_show))
                                        <label>
                                            <input type="checkbox" id="selfpickup-is_show"
                                                   class="form-control b-n" name="SelfPickup[is_show]"
                        ...
                        <div class="help-block help-block-t"><div class="help-block help-block-t">是，消费者前台商品详情页、前台结算时能选择此自提点；否，自提点不在前台商品详情页、结算页面展示</div></div>
                    </div>
                </div>
            </div>
            <!-- 商家推荐-->
            <div class="simple-form-field" >
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        ...
                        <div class="help-block help-block-t"><div class="help-block help-block-t">在pc端自提点介绍页面，手机端商品详情页查看自提点列表中显示，描述自提点的活动或相关备注（最多200字）</div></div>
                    </div>
                </div>
            </div>
            ...
            <div class="simple-form-field" >
                <div class="form-group">
                    <label for="selfpickup-sort" class="col-sm-4 control-label">
                        <span class="text-danger ng-binding">*</span>
                        <span class="ng-binding">排序：</span>
                    </label>
                    <div class="col-sm-8">
                        <div class="form-control-box">
                            <input type="text" id="selfpickup-sort" class="form-control small" name="SelfPickup[sort]" value="{{ $info->sort ?? 255 }}">
                        </div>
...
[{"id": "selfpickup-pickup_name", "name": "SelfPickup[pickup_name]", "attribute": "pickup_name", "rules": {"required":true,"messages":{"required":"自提点名称不能为空。"}}},{"id": "selfpickup-region_code", "name": "SelfPickup[region_code]", "attribute": "region_code", "rules": {"required":true,"messages":{"required":"自提点地址不能为空。"}}},{"id": "selfpickup-pickup_address", "name": "SelfPickup[pickup_address]", "attribute": "pickup_address", "rules": {"required":true,"messages":{"required":"详细地址不能为空。"}}},{"id": "selfpickup-pickup_images", "name": "SelfPickup[pickup_images]", "attribute": "pickup_images", "rules": {"required":true,"messages":{"required":"自提点图片不能为空。"}}},{"id": "selfpickup-sort", "name": "SelfPickup[sort]", "attribute": "sort", "rules": {"required":true,"messages":{"required":"排序不能为空。"}}},{"id": "selfpickup-shop_id", "name": "SelfPickup[shop_id]", "attribute": "shop_id", "rules": {"required":true,"messages":{"required":"Shop ID不能为空。"}}},{"id": "selfpickup-shop_id", "name": "SelfPickup[shop_id]", "attribute": "shop_id", "rules": {"integer":{"pattern":"/^\\s*[+-]?\\d+\\s*$/"},"messages":{"integer":"Shop ID必须是整数。"}}},{"id": "selfpickup-is_show", "name": "SelfPickup[is_show]", "attribute": "is_show", "rules": {"integer":{"pattern":"/^\\s*[+-]?\\d+\\s*$/"},"messages":{"integer":"是否显示必须是整数。"}}},{"id": "selfpickup-is_delete", "name": "SelfPickup[is_delete]", "attribute": "is_delete", "rules": {"integer":{"pattern":"/^\\s*[+-]?\\d+\\s*$/"},"messages":{"integer":"Is Delete必须是整数。"}}},{"id": "selfpickup-address_lng", "name": "SelfPickup[address_lng]", "attribute": "address_lng", "rules": {"required":true,"messages":{"required":"经纬度不能为空。"}}},{"id": "selfpickup-address_lat", "name": "SelfPickup[address_lat]", "attribute": "address_lat", "rules": {"required":true,"messages":{"required":"经纬度不能为空。"}}},{"id": "selfpickup-pickup_tel", "name": "SelfPickup[pickup_tel]", "attribute": "pickup_tel", "rules": {"match":{"pattern":/^((0\d{2,3}-\d{7,8})|(1[3567894]\d{9}))$/,"not":false,"skipOnEmpty":1},"messages":{"match":"请输入正确的手机或座机号码，座机号码格式：XXXX-XXXXXXX。"}}},{"id": "selfpickup-pickup_name", "name": "SelfPickup[pickup_name]", "attribute": "pickup_name", "rules": {"string":true,"messages":{"string":"自提点名称必须是一条字符串。","maxlength":"自提点名称只能包含至多20个字符。"},"maxlength":20}},{"id": "selfpickup-region_code", "name": "SelfPickup[region_code]", "attribute": "region_code", "rules": {"string":true,"messages":{"string":"自提点地址必须是一条字符串。","maxlength":"自提点地址只能包含至多20个字符。"},"maxlength":20}},{"id": "selfpickup-pickup_address", "name": "SelfPickup[pickup_address]", "attribute": "pickup_address", "rules": {"string":true,"messages":{"string":"详细地址必须是一条字符串。","maxlength":"详细地址只能包含至多255个字符。"},"maxlength":255}},{"id": "selfpickup-address_lng", "name": "SelfPickup[address_lng]", "attribute": "address_lng", "rules": {"string":true,"messages":{"string":"经度必须是一条字符串。","maxlength":"经度只能包含至多60个字符。"},"maxlength":60}},{"id": "selfpickup-address_lat", "name": "SelfPickup[address_lat]", "attribute": "address_lat", "rules": {"string":true,"messages":{"string":"纬度必须是一条字符串。","maxlength":"纬度只能包含至多60个字符。"},"maxlength":60}},{"id": "selfpickup-pickup_tel", "name": "SelfPickup[pickup_tel]", "attribute": "pickup_tel", "rules": {"string":true,"messages":{"string":"联系电话必须是一条字符串。","maxlength":"联系电话只能包含至多15个字符。"},"maxlength":15}},{"id": "selfpickup-pickup_images", "name": "SelfPickup[pickup_images]", "attribute": "pickup_images", "rules": {"string":true,"messages":{"string":"自提点图片必须是一条字符串。","maxlength":"自提点图片只能包含至多500个字符。"},"maxlength":500}},{"id": "selfpickup-pickup_desc", "name": "SelfPickup[pickup_desc]", "attribute": "pickup_desc", "rules": {"string":true,"messages":{"string":"商家推荐必须是一条字符串。","maxlength":"商家推荐只能包含至多200个字符。"},"maxlength":200}},{"id": "selfpickup-sort", "name": "SelfPickup[sort]", "attribute": "sort", "rules": {"integer":{"pattern":"/^\\s*[+-]?\\d+\\s*$/"},"messages":{"integer":"排序必须是整数。","min":"排序必须不小于0。","max":"排序必须不大于255。"},"min":0,"max":255}},]
</script>
    <script type="text/javascript">
        //
    </script>
