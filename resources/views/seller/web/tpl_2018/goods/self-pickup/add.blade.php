...
@section('footer_script')
    ...
    <!-- 在线文本编辑器 -->
    <script src="/assets/d2eace91/js/editor/kindeditor-all.min.js?v=20180813"></script>
    <script src="/assets/d2eace91/js/editor/lang/zh_CN.js?v=20180813"></script>
    ...
    <script type="text/javascript">
        KindEditor.ready(function(K) {
            ...
            extraFileUploadParams['B2B2C_YUNMALL_68MALL_COM_USER_PHPSESSID'] = 'kmrhdmiev5q5aitr8c36oidcg2';
