...
<div style="display: block;" class='page-1 pos-r p-b-30'>
    <div class="p-b-30" style="overflow-y:scroll; max-height:465px;">
        ...
        <div class="guide-content" style="width:990px;">
            <img class="guide-content-image" src="../../../images/guide/step1.png" style="margin-right: 120px;" alt="第一步：店铺基本设置" width="555">
            <dl class="step-text left" style="top: 65px; left: 50px;">
                <dt>1</dt>
            ...
            <dl class="step-text left" style="top: 260px; left: 50px;">
                <dt>3</dt>
                <dd>如果店铺支持上门提货，则运营之前需要设置好提货的网点信息</dd>
            </dl>
        </div>
    </div>
    <div class="modal-footer text-r">
...
<div style="display: none" class='page-2 pos-r p-b-30'>
    <div class="p-b-30"  style="overflow-y:scroll; max-height:465px;">
        ...
        <div class="guide-content" style="width:990px;">
            <img class="guide-content-image" src="../../../images/guide/step2.png" style="margin-right: 120px;" alt="店铺与消费者之间的互动工具设置" width="558">
            <dl class="step-text left" style="top: 65px; left: 0px; width: 220px">
                <dt>1</dt>
                <dd>设置店铺不同的管理员，分别打理店铺</dd>
            </dl>
            <dl class="step-text left" style="top: 115px; left: 0px; width: 220px">
                <dt>2</dt>
                <dd>云客服、云旺客服，使用率较高的客服工具，可自行选择是否使用</dd>
            </dl>
            <dl class="step-text left" style="top: 200px; left: 0px; width: 225px">
                <dt>3</dt>
...
<div style="display: none" class='page-3 pos-r p-b-30'>
    <div class="p-b-30"  style="overflow-y:scroll; max-height:465px;">
        ...
        <div class="guide-content" style="height:360px; width:990px">
            <img class="guide-content-image" style="margin-right: 120px;" src="../../../images/guide/step3.png" alt="第三步：会员整理" width="575">
            <dl class="step-text left" style="top:392px; left: 60px;">
...
<div style="display: none" class='page-4 pos-r p-b-30'>
    <div class="p-b-30"  style="overflow-y:scroll; max-height:465px;">
        ...
        <div class="guide-content" style="width:990px;">
            <img class="guide-content-image" style="margin-right: 150px;" src="../../../images/guide/step4.png" alt="第四步：商品维护" width="449">
            <dl class="step-text left" style="top: 185px; left: 240px;">
                <dt>1</dt>
                <dd>添加店铺商品分类</dd>
            </dl>
            <dl class="step-text left" style="top: 263px; left: 193px;">
                <dt>2</dt>
                <dd>设置店铺售卖的范围及运费</dd>
            </dl>
            <dl class="step-text left" style="top: 185px; max-width: 260px; left: 110px;">
                <dt>3</dt>
                <dd>
                    维护商品数据：
                    </br>
...
<div style="display: none" class='page-5 pos-r p-b-30'>
    <div class="p-b-30"  style="overflow-y:scroll; max-height:465px;">
        ...
        <div class="guide-content" style="width:990px;">
            <img class="guide-content-image" style="margin-right: 60px;" src="../../../images/guide/step5.png" alt="第五步：交易设置" width="662">
            <dl class="step-text left" style="top: 325px; left: 60px;">
...
<div style="display: none" class='page-6 pos-r p-b-30'>
    <div class="p-b-30"  style="overflow-y:scroll; max-height:465px;">
        ...
        <div class="guide-content" style="width:990px;">
            <img class="guide-content-image" style="margin-right: 100px;" src="../../../images/guide/step6.png" alt="第六步：装修" width="628">
            <dl class="step-text left" style="top: 350px; left: 100px;">
                <dt>1</dt>
                <dd>店铺导航菜单设置</dd>
            </dl>
            <dl class="step-text left" style="top: 390px; left: 100px;">
                <dt>2</dt>
                <dd>进行店铺装修设计</dd>
            </dl>
        </div>
    ...
    <div class="modal-footer text-r">
        <label class="pull-left cur-p m-t-5">
            <input id='next_display' class="cur-p m-r-5 va-sub" type="checkbox" checked="checked" value="" />
            下次访问不展示该指引
        </label>
        <button class='btn btn-primary pre' data-current='6' data-pre='5'>上一步</button>
        <button class='btn btn-primary next' data-current='6'>收起指引</button>
    </div>
</div>
