...
@section('content')
    ...
    <form id="ShopRankModel" class="form-horizontal" name="ShopRankModel" action="/member/rank/add?is_special=1" method="post">
        ...
        <div class="table-content m-t-30 clearfix">
                        ...
                        <div class="form-control-box">
                            ...
                            @if(!isset($info->rank_id))
                                ...
                                <div id="shoprankmodel-is_special" class="" name="ShopRankModel[is_special]">
                                    <label class="control-label cur-p m-r-10"><input type="radio" name="ShopRankModel[is_special]" value="1" checked> 是</label>
                                    <label class="control-label cur-p m-r-10"><input type="radio" name="ShopRankModel[is_special]" value="0"> 否</label>
                                </div>
                            @else
                                <label class="control-label">是</label>
                                <input type="hidden" id="shoprankmodel-is_special" class="form-control" name="ShopRankModel[is_special]" value="1">
                            @endif
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <div class="form-control-box">
                            ...
                            <input type="text" id="shoprankmodel-rank_name" class="form-control" name="ShopRankModel[rank_name]" value="{{ $info->rank_name ?? '' }}">
            ...
            <!-- 会员等级有效期 -->
            <div class="simple-form-field between">
                <div class="form-group">
                    <label class="col-sm-4 control-label">
                        <span class="ng-binding">会员等级有效期：</span>
                    </label>
                    <div class="col-sm-8">
                        <div class="form-control-box">
                            <label class="control-label cur-p m-r-10 ">

                                <input type="radio" name="ShopRankModel[use_between]" value="0" @if(@$info->use_between == 0) checked @endif>
            ...
            <div class="simple-form-field between">
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <div class="form-control-box">
                            <label class="control-label cur-p m-r-10 p-t-0">

                                <input type="radio" name="ShopRankModel[use_between]" value="1" @if(@$info->use_between == 1) checked @endif>

                                <input type="text" id="shoprankmodel-start_time" class="form-control form_datetime ipt" name="ShopRankModel[start_time]" value="{{ $info->start_time ?? '' }}" placeholder="开始时间">

                                <span class="ctime">至</span>

                                <input type="text" id="shoprankmodel-end_time" class="form-control form_datetime ipt" name="ShopRankModel[end_time]" value="{{ $info->end_time ?? '' }}" placeholder="结束时间">
                            </label>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-sm-8">
                        <div class="form-control-box">
                            <label class="control-label cur-p m-r-10 p-t-0">
                                ...
                                <input type="radio" name="ShopRankModel[use_between]" value="2" @if(@$info->use_between == 2) checked @endif>

                                成为等级会员后<input type="text" id="shoprankmodel-valid_days" class="form-control ipt m-l-10 m-r-10" name="ShopRankModel[valid_days]" value="{{ $info->valid_days ?? 0 }}">天内有效
                            </label>
                        </div>
                    </div>
                </div>
            </div>
            <div id="div_expired_level" >
                <!-- 过期设置 -->
                <div class="simple-form-field" >
                    <div class="form-group">
                        <label for="shoprankmodel-expired_level" class="col-sm-4 control-label">
                            <span class="text-danger ng-binding">*</span>
                            <span class="ng-binding">过期设置：</span>
                        </label>
                        <div class="col-sm-8">
                            <div class="form-control-box">


                                <label class="control-label">过期后调整至</label>
                                <select id="shoprankmodel-expired_level" class="form-control" name="ShopRankModel[expired_level]">
                                    <option value="0">非会员</option>
                                    @foreach($shop_rank_list as $v)
                                    <option value="{{ $v->rank_id }}" @if(@$info->expired_level == $v->rank_id) selected @endif>{{ $v->rank_name }}</option>
                                    @endforeach
                                </select>
