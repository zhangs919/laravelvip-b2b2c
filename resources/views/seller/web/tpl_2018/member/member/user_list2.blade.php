...
@section('content')
    ...
    <div class="search-term m-b-10">
        <form id="searchForm" action="/member/member/user-list.html" method="GET">
            ...
            <div class="simple-form-field ">
                <div class="form-group">
                    ...
                    <div class="form-control-wrap">
                        <input type="text" id="close_begin" class="form-control form_datetime ipt" name="close_begin" placeholder="不限">

                        <span class="ctime">至</span>
                        <input type="text" id="close_end" class="form-control form_datetime ipt" name="close_end" placeholder="不限">
                    </div>
                </div>
            </div>
            <!--<div class="simple-form-field ">
            ...
            <div class="simple-form-field">
                ...
                <input type="button" id="btn_export" class="btn btn-default m-r-5" data-type="2" data-order="2" value="导出" />
    ...
    <div class="table-responsive">
        <!---->
        {{--引入列表--}}
        @include('member.member.partials._user_list2')
        <!---->
    </div>
