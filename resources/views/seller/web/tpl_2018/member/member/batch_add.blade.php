...
@section('content')
    <div class="table-content m-t-30">
        <form id="form" class="form-horizontal" action="/member/member/batch-add.html" method="post" enctype="multipart/form-data">
            <input type="hidden" name="_csrf" value="-R9UcJmq9LUnkvFTLue5SGnDpPpj97DOd-G8WqYyDeWDLDwK8sOx_hfdojZE0_gqJJXDnwax3IQBrM0Ongp10w==">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        ...
                        <div class="help-block help-block-t">
                            <a class="btn-link" href="download.html" target="_blank">下载上传会员文件模板</a>
                        </div>
                        <div class="help-block help-block-t">
            ...
            <div class="simple-form-field p-b-30">
                <div class="form-group">
                    ...
                    <div class="col-xs-8">
                        <input type="button" id="btn_submit" value="提交" class="btn btn-primary">
