            ...
            <div class="simple-form-field" >
                <div class="form-group">
                    <label for="topicmodel-header_style" class="col-sm-4 control-label">
                        ...
                        <span class="ng-binding">去除头部：</span>
                    </label>
                    <div class="col-sm-8">
                        <div class="form-control-box">
                            ...
                            <div id="topicmodel-header_style" class="extend_condition" name="TopicModel[header_style]" selection='[""]'>
                                @if(isset($info->topic_id))
                                    <label class="control-label cur-p m-r-10"><input type="checkbox" name="TopicModel[header_style][]" value="1" @if(in_array(1, $info->header_style)) checked @endif> 店铺顶部导航</label>
                                    ...
                                    <label class="control-label cur-p m-r-10"><input type="checkbox" name="TopicModel[header_style][]" value="3" @if(in_array(3, $info->header_style)) checked @endif> 店铺主导航</label>
                                @else
                                    <label class="control-label cur-p m-r-10"><input type="checkbox" name="TopicModel[header_style][]" value="1"> 店铺顶部导航</label>
                                    <label class="control-label cur-p m-r-10"><input type="checkbox" name="TopicModel[header_style][]" value="2"> 头部信息</label>
                                    <label class="control-label cur-p m-r-10"><input type="checkbox" name="TopicModel[header_style][]" value="3"> 店铺主导航</label>
                                @endif
                            </div>
            ...
            <div class="simple-form-field" >
                <div class="form-group">
                    <label for="topicmodel-bottom_style" class="col-sm-4 control-label">
                        ...
                        <span class="ng-binding">去除底部：</span>
                    </label>
                    <div class="col-sm-8">
                        <div class="form-control-box">
                            ...
                            <div id="topicmodel-bottom_style" class="extend_condition" name="TopicModel[bottom_style]" selection='[""]'>
                                @if(isset($info->topic_id))
                                    ...
                                    <label class="control-label cur-p m-r-10"><input type="checkbox" name="TopicModel[bottom_style][]" value="2" @if(in_array(2, @$info->bottom_style)) checked @endif> 友情连接</label>
                                ...
                                @else
                                    ...
                                    <label class="control-label cur-p m-r-10"><input type="checkbox" name="TopicModel[bottom_style][]" value="2"> 友情连接</label>
                        ...
                        <div class="help-block help-block-t"><div class="help-block help-block-t">底部信息指帮助文章下方的所有内容</div></div>
                    </div>
                </div>
            </div>
            <!-- 描述 -->
