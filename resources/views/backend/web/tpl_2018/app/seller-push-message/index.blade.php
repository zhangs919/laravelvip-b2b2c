...
@section('content')
    ...
    <div class="table-content m-t-30 clearfix">
        <form id="PushMessageModel" class="form-horizontal" name="PushMessageModel" action="/app/seller-push-message/index" method="post" enctype="multipart/form-data" novalidate="novalidate">
            @csrf
            <!-- 推送标题-->
