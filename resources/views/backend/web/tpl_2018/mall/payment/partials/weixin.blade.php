...
<div class="simple-form-field">
    <div class="form-group">
        <label for="text4" class="col-sm-4 control-label">
            <!--<span class="text-danger ng-binding">*</span>-->
            <span class="ng-binding">转账证书ca：</span>
        </label>
        <div class="col-sm-8">
            <div class="form-control-box">
                ...
                <div class="file-attach-1">
                    ...
                    <input class="inputstyle valid upload-file" data-id="rootca" type="file" name="rootca">
                    <input type="hidden" id="rootca" name="rootca_file" value="{{ $info->pay_config[6]['config_value'] ?? ''}}">
    ...
    <input type="hidden" name="pay_name[]" value="rootca">
    <input type="hidden" name="pay_type[]" value="file-button">
</div>