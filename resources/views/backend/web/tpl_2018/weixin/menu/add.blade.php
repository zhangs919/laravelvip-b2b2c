...
@section('content')
    ...
    <div class="table-content m-t-30 clearfix">
        <form id="WeixinMenu" class="form-horizontal" name="WeixinMenu" action="/weixin/menu/add" method="post" enctype="multipart/form-data">
            @csrf
            <!-- 隐藏域 -->
            ...
            <div id="content">
                ...
                <!-- ================== END BASE  ================== -->
                <!--引入菜单类型内容-->
                @include('weixin.menu.change_type_'.$model['menu_type'])
            </div>
            <!-- 排序 -->
            <div class="simple-form-field" >
                <div class="form-group">
