<div class="table-responsive">
    ...
    <table id="table_list" class="table table-hover">
        ...
        <tr>
            ...
            <th data-sortname="ad_name">广告名称</th>
            <th class="text-c" data-sortname="ad_image">广告图片</th>
            <th data-sortname="ad_link">广告链接</th>
            <th class="text-c" data-sortname="is_show">是否显示</th>
            <th class="text-c" data-sortname="ad_sort">广告排序</th>
