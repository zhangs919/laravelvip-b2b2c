                ...
                <div class="electronic">
                    ...
                    <div class="floor-layout">
                        <div class="floor-content6">
                            ...
                            <span class="img-right-line img-right-line-v"></span>
                            <div class="floor-img floor-img-box">
                                <div class="floor-img-left">
                        ...
                        <div class="floor-con6-brand">
                            ...
                            @if($tpl_name != '' && $is_design)
                                <a class="selector brand-selector SZY-TPL-SELECTOR" title="编辑" data-uid="{{ $uid }}" data-cat_id="1" data-type="5" data-number="24">
                                    <i class="fa fa-edit"></i>
                                    编辑
                                </a>
                            @endif
                            <div class="tabs-brand">
                                <div class="brand">
                                    <div class="brand-con">
                                        <ul class="brand-list" style="position: absolute; width: 1188px; height: 36px; top: 0px; left: 0px;">
