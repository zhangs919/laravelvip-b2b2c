                            ...
                            <div class="floor-suspend">
                                ...
                                @if(!empty($data['3-1']))
                                    @foreach($data['3-1'] as $v)
                                        <a href="{{ $v['link'] ?? 'javascript:void(0)' }}" class="floor-ad-img" style="">
                                            <img class="" src="{{ get_image_url($v['path']) }}" data-original="{{ get_image_url($v['path']) }}" width="210" height="485" style="display: inline;">
                                        </a>
                                    @endforeach
                                @else
                                    <a href="javascript:void(0)" class="floor-ad-img example-text floor-special dark">
<span>
此处添加
<br>
【210*485】图片
                        ...
                        <div class="floor-middle">
                            <div class="floor-banner">
                                @if($tpl_name != '' && $is_design)
                                    <a href="javascript:void(0)" class="selector pic-selector SZY-TPL-SELECTOR" title="编辑" data-uid="{{ $uid }}" data-cat_id="2" data-type="3" data-number="3">
                                        <i class="fa fa-edit"></i>
                                        编辑
                                    </a>
                                @endif
                                ...
                                <div class="floor-tabs-ad-up">
                                    ...
                                    @if(!empty($data['3-3']))
                                        @foreach($data['3-3'] as $k=>$v)
                                            <a href="{{ $v['link'] ?? 'javascript:void(0)' }}" class="floor-tabs-ad-img @if($k == 0) first @endif" style="background: url({{ get_image_url(sysconf('default_lazyload')) }}) no-repeat center center">
                                                <img class="lazy" src="/assets/d2eace91/images/common/blank.png" data-original="{{ get_image_url($v['path']) }}" />
                                            </a>
                                        @endforeach
                                    @else
                                        @for($i=1; $i <= 3; $i++)
                                            <a href="javascript:void(0)" class="floor-tabs-ad-img @if($i == 1) first @endif example-text special dark">
<span>
此处添加
<br>
【202*300】图片
                                ...
                                <div class="floor-tabs-ad-down">
                                    @if($tpl_name != '' && $is_design)
                                        <a href="javascript:void(0)" class="selector pic-selector SZY-TPL-SELECTOR" title="编辑" data-uid="{{ $uid }}" data-cat_id="4" data-type="3" data-number="2">
                                            <i class="fa fa-edit"></i>
                                            编辑
                                        </a>
                                    @endif
                                    ...
                                    @if(!empty($data['3-4']))
                                        @foreach($data['3-4'] as $k=>$v)
                                            <a href="{{ $v['link'] ?? 'javascript:void(0)' }}" class="floor-tabs-ad-img @if($k == 0) first @endif">
                                                <img class="lazy" src="/assets/d2eace91/images/common/blank.png" data-original="{{ get_image_url($v['path']) }}" />
                                            </a>
                                        @endforeach
                                    @else
                                        @for($i=1; $i <= 2; $i++)
                                            <a href="javascript:void(0)" class="floor-tabs-ad-img @if($i == 1) first @endif example-text dark">
                                        ...
                                        @if(@$data['2-'.$i][$gi] != null)
                                            <div class="item" >
                                                <div class="wrap">
                                                    ...
                                                    <p class="title">
                                                        <a target="" href="{{ route('pc_show_goods',['goods_id'=>$data['2-'.$i][$gi]['goods_id']]) }}" title="{{ $data['2-'.$i][$gi]['goods_name'] }}">{{ $data['2-'.$i][$gi]['goods_name'] }}</a>
                                                    </p>
                                                    <p class="price">
                                        ...
                                        @else
                                            <div class="item">
                                                <div class="wrap">
                                                    ...
                                                    <p class="title">
                                                        <a target="_blank" href="javascript:void(0);" title="">商品名称</a>
                                                    </p>
                                                    <p class="price">
