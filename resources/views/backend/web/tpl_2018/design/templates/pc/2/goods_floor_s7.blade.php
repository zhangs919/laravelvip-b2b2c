                                                    ...
                                                    @foreach($data['5-3'] as $v)
                                                        <li>
                                                            <a href="javascript:void(0)" target="" title="马代苏">
                                                                <img class="" src="http://68yun.oss-cn-beijing.aliyuncs.com/images/15164/goods/brand/2018/05/26/15273649247226.jpg" data-original="http://68yun.oss-cn-beijing.aliyuncs.com/images/15164/goods/brand/2018/05/26/15273649247226.jpg" width="100" height="40" alt="马代苏" style="display: block;">
                                                            </a>
                                                        </li>
                                                    @endforeach
                                                @else
