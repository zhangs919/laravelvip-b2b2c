...
<div class="drop-item {{ $is_valid != '1' ? 'invalid' : ''}}" id='{{ $uid }}' data-tpl_name='{{ $tpl_name }}' data-is_valid='{{ $is_valid }}'>
    ...
    <div class="w1210 floor-list"
         data-floor_name="@if(!empty($data['4-1'])){{ $data['4-1'][0]['floor_name'] }}@endif"
         data-short_name="@if(!empty($data['4-1'])){{ $data['4-1'][0]['short_name'] }}@endif">
                ...
                <div class="floor-con floor-con1">
                    <div class="floor-title">
                        ...
                        <ul class="floor-tabs-nav">
                            ...
                            <li @if($i == 1) class="floor-tabs-selected" @endif>
                                ...
                                <h3 @if($i == 1) style='border-color: {{ $bg_color }} {{ $bg_color }} #fff; color: {{ $bg_color }};' @endif>{{ $ext_info['cat'][$i] ?? '添加商品'}}</h3>
                    ...
                    <div class="floor-content">
                        ...
                        <div class="floor-right">
                            ...
                            @for($i=1; $i <= 4; $i++)
                                <div class="floor-tabs-panel @if($i > 1) floor-tabs-hide @endif" style='border-top: 1px {{ $bg_color }} solid;'>
