			...
			<div class="form-group">
				...
				<div class="col-sm-9">
					<div class="form-control-box">
						<span>
							<input type="hidden" id="navcategorymodel-nav_icon" class="form-control w200 m-r-10" name="NavCategoryModel[nav_icon]">
							<i class="iconfont iconfont-box iconfont-bg" id="show_icon">

							</i>
							<span class="btn btn-warning btn-sm m-l-10" id="select_icon">选择图标</span>
							<span class="btn btn-warning btn-sm m-l-5 hide" id="del_icon">删除图标</span>
						</span>
					</div>
				</div>
			</div>
				...
				<div class="col-sm-9 data-row">
					<div class="form-control-box">
						...
						<span class="category-link">
							...
							<input class="form-control" type="text" value="" name="link" placeholder='示例：http://www.xxx.com'>
						</span>
					</div>
				</div>
			</div>
