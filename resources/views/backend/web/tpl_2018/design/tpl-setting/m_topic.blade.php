...
@section('header_js')
    ...
    <link rel="stylesheet" href="/assets/d2eace91/css/styles.css?v=1.6"/> <link rel="stylesheet" href="/assets/d2eace91/css/design/mobile/swiper.min.css?v=1.6"/>
        ...
        <div class="module-topBar-inner">
            ...
            <div class="topBar-navbar-r">
                <div class="top-set-btn displayMode">
                    <a href="/design/tpl-setting/setup?page=topic&amp;topic_id=6" class="set-btn" title="电脑端装修">
                    ...
                    <a href="/design/tpl-setting/setup?page=app_topic&amp;topic_id=6" class="set-btn" title="微商城装修">
                    ...
                    <fieldset class="panelItemBox">
                        ...
                        <ul class="panelModuleIconContainer">
                            ...
                            <li class="drag" id="0" data-code="m_topic_s1" style="z-index: 3">
                                ...
                                <a href="javascript:void(0);" class="panelModuleTitle" title="专题活动一">专题活动一</a>
                            </li>
                            ...
                            <li class="drag" id="0" data-code="m_topic_s2" style="z-index: 3">
                                ...
                                <a href="javascript:void(0);" class="panelModuleTitle" title="专题活动二">专题活动二</a>
                            </li>
                ...
                <div class="special-item">
                    ...
                    <div class="SZY-TPL-FOOTER footer-nav-box"><!--底部菜单 start-->
                        ...
                        <div class="footer-nav">
                            ...
                            <a href="javascript:void(0)" class="content-selector SZY-TPL-SETTING" data-url='/design/navigation/list.html?nav_page=m_topic3&nav_position=3' data-title='导航设置' data-tpl='@frontend/web_mobile/modules/library/topic_footer_menu.tpl' data-container='.SZY-TPL-FOOTER'>
