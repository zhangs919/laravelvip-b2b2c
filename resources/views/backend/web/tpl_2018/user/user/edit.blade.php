    ...
    <form id="UserModel" class="form-horizontal" name="UserModel" action="/user/user/edit?id={{ $info->user_id }}" method="post" novalidate="novalidate">
        ...
        <div class="table-content m-t-30 clearfix">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <div class="form-control-box">
                            ...
                            <input type="text" id="usermodel-user_name" class="form-control" name="UserModel[user_name]" value="{{ $info->user_name }}" disabled="disabled" autocomplete="off">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <div class="form-control-box">
                            ...
                            <input type="password" id="pwd-input" class="form-control" name="UserModel[password]" value="" maxlength="30" autocomplete="off">
                            <i class="fa fa-eye-slash pwd-toggle" data-id="pwd-input"></i>


                        </div>

                        <div class="help-block help-block-t">留空 则不修改密码</div>
                    </div>
                </div>
            </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <div class="form-control-box">
                            ...
                            <input type="text" id="usermodel-nickname" class="form-control" name="UserModel[nickname]" value="{{ $info->nickname }}">
                        ...
                        <div class="form-control-box">
                            ...
                            <select id="usermodel-rank_id" name="UserModel[rank_id]" class="chosen-select" style="display: none;">
                                ...
                                @foreach($user_rank as $v)
                                    <option value="{{ $v->rank_id }}" @if($v->min_points > 0) disabled="true" @endif @if($info->rank_id == $v->rank_id) selected="" @endif>{{ $v->rank_name }}</option>
                        ...
                        <div class="form-control-box">
                            <div id="" class="" name="">
                                <label class="control-label cur-p m-r-10">
                                    ...
                                    <input type="radio" name="UserModel[use_between]" value="{{ $info->use_between }}">
                                ...
                                <label class="control-label cur-p m-r-10">
                                    ...
                                    <input type="radio" name="UserModel[use_between]" value="1" checked="">

                                    <input type="text" id="usermodel-rank_start_time" class="form-control form_datetime ipt pull-none" name="UserModel[rank_start_time]" value="{{ $info->rank_start_time }}" placeholder="开始时间">

                                    &nbsp;~&nbsp;

                                    <input type="text" id="usermodel-rank_end_time" class="form-control form_datetime ipt pull-none" name="UserModel[rank_end_time]" value="{{ $info->rank_end_time }}" placeholder="结束时间">
                                </label>
                            </div>
                        </div>
            ...
            <script>
                $(function() {
                    $.dateselector({
                        defaulttime: "{{ date('Y-m-d', strtotime($info->birthday)) }}",
                        sel_unix: "#birthday"
                    });
                });
            </script>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <div class="form-control-box">
                            ...
                            <textarea id="usermodel-detail_address" class="form-control" name="UserModel[detail_address]" rows="5" style="height:60px">{{ $info->detail_address }}</textarea>
            ...
            <div class="simple-form-field">
                <div class="form-group">
                    <label for="text4" class="col-sm-4 control-label">
                        <span class="ng-binding">注册来源：</span>
                    </label>
                    <div class="col-sm-8">
                        <label class="control-label">{{ format_user_reg_from($info->reg_from) }}</label>
                    </div>
                </div>
            </div>
            <div class="simple-form-field">
                <div class="form-group">
                    <label class="col-sm-4 control-label">
                        <span class="ng-binding">注册IP地址：</span>
                    </label>
                    <div class="col-sm-8">
                        <label class="control-label">{{ $info->reg_ip }}</label>
                    </div>
                </div>
            </div>
            <div class="simple-form-field">
                <div class="form-group">
                    <label class="col-sm-4 control-label">
                        <span class="ng-binding">注册时间：</span>
                    </label>
                    <div class="col-sm-8">
                        <label class="control-label">{{ $info->reg_time }}</label>
                    </div>
                </div>
            </div>
            <div class="simple-form-field">
                <div class="form-group">
                    <label class="col-sm-4 control-label">
                        <span class="ng-binding">登录次数：</span>
                    </label>
                    <div class="col-sm-8">
                        <label class="control-label">{{ $info->visit_count }}</label>
                    </div>
                </div>
            </div>
            <div class="simple-form-field">
                <div class="form-group">
                    <label class="col-sm-4 control-label">
                        <span class="ng-binding">上次登录IP：</span>
                    </label>
                    <div class="col-sm-8">
                        <label class="control-label">{{ $info->last_ip }}</label>
                    </div>
                </div>
            </div>
            <div class="simple-form-field">
                <div class="form-group">
                    <label class="col-sm-4 control-label">
                        <span class="ng-binding">上次登录时间：</span>
                    </label>
                    <div class="col-sm-8">
                        <label class="control-label">{{ $info->last_login }}</label>
                    </div>
                </div>
            </div>
            ...
            <div class="simple-form-field">
                <div class="form-group">
                    <label for="text4" class="col-sm-4 control-label">
                        <span class="ng-binding">可用余额（可提现）：</span>
                    </label>
                    <div class="col-sm-8">
                        <label class="control-label">
                            <strong class="c-red m-r-5">{{ $info->user_money }}元</strong>
                        </label>
                    </div>
                </div>
            </div>
            <div class="simple-form-field">
                <div class="form-group">
                    <label for="text4" class="col-sm-4 control-label">
                        <span class="ng-binding">可用余额（禁提现）：</span>
                    </label>
                    <div class="col-sm-8">
                        <label class="control-label">
                            <strong class="c-red m-r-5">{{ $info->user_money_limit }}元</strong>
                        </label>
                    </div>
                </div>
            </div>
            <div class="simple-form-field">
                <div class="form-group">
                    <label for="text4" class="col-sm-4 control-label">
                        <span class="ng-binding">冻结资金：</span>
                    </label>
                    <div class="col-sm-8">
                        <label class="control-label">
                            <strong class="c-red m-r-5">{{ $info->frozen_money }}元</strong>
                        </label>
                    </div>
                </div>
            </div>
            <div class="simple-form-field">
                <div class="form-group">
                    <label for="text4" class="col-sm-4 control-label">
                        <span class="ng-binding">消费积分：</span>
                    </label>
                    <div class="col-sm-8">
                        <label class="control-label">
                            <strong class="c-red m-r-5">  {{ $info->pay_point }}  </strong>
                        </label>
                    </div>
                </div>
            </div>
