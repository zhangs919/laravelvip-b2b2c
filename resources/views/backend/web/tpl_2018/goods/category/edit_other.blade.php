                        ...
                        <div class="form-control-box">
                            ...
                            <ul id="spec_values" class="spec-value">
                                ...
                                <li class="m-b-10">
                                    ...
                                    <label><input type="checkbox" class="cur-p" name="is_input" value="1" @if($v->is_input) checked @endif> 允许输入</label><i class="fa fa-question-circle f16 c-ddd cur-p m-l-5 m-r-10" data-toggle="popover" data-trigger="hover" data-placement="right" data-html="true" data-content="<img width='150' height='80' src='/backend/images/goods/pattern1.png'>"></i>

                                    <input type="hidden" name="is_alias" value="0">
                                    <label><input type="checkbox" class="cur-p" name="is_alias" value="1" @if($v->is_alias) checked @endif> 别名</label><i class="fa fa-question-circle f16 c-ddd cur-p m-l-5 m-r-10" data-toggle="popover" data-trigger="hover" data-placement="right" data-html="true" data-content="<img width='150' height='80' src='/backend/images/goods/pattern2.png'>"></i>

                                    <input type="hidden" name="is_desc" value="0">
                                    <label><input type="checkbox" class="cur-p" name="is_desc" value="1" @if($v->is_desc) checked @endif> 备注</label><i class="fa fa-question-circle f16 c-ddd cur-p m-l-5 m-r-10" data-toggle="popover" data-trigger="hover" data-placement="right" data-html="true" data-content="<img width='150' height='80' src='/backend/images/goods/pattern3.png'>"></i>

                                    <input type="hidden" name="is_filter" value="0">
                                    <label><input type="checkbox" class="cur-p" name="is_filter" value="1" @if($v->is_filter) checked @endif> 筛选</label><i class="fa fa-question-circle f16 c-ddd cur-p m-l-5 m-r-10" data-toggle="popover" data-trigger="hover" data-placement="right" data-html="true" data-content="<img width='150' height='80' src='/backend/images/goods/pattern4.png'>"></i>
