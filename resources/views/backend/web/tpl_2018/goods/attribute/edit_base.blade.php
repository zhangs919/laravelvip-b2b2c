...
@section('content')
    ...
    <div class="table-content m-t-30 clearfix">
        ...
        <form id="AttributeModel" class="form-horizontal" name="AttributeModel" action="/goods/attribute/edit-base?id={{ $info->attr_id }}&amp;type_id={{ $type_id }}" method="POST" novalidate="novalidate">
            {{ csrf_field() }}
            <!-- 隐藏域 -->
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <div class="form-control-box">
                            ...
                            <label class="control-label cur-p"><input type="radio" id="attributemodel-attr_style" class="" name="AttributeModel[attr_style]" value="{{ $info->attr_style }}" checked=""> {{ attr_style($info->attr_style) }}</label>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <div class="form-control-box">
                            ...
                            <div id="values_select" class="attr-values-area">
                                <ul class="attr-values">
                                    ...
                                    <li class="m-b-10 attr-value">
                                        ...
                                        <input type="text" id="attrvalue-attr_vname" class="form-control" name="attr_vname" value="{{ $v->attr_vname }}" placeholder="请输入属性可选值">

                                        <input type="text" id="attrvalue-attr_vsort" class="form-control small m-l-10" name="attr_vsort" value="{{ $v->attr_vsort }}" placeholder="排序">
                            ...
                            @else
                            <div id="values_text" class="attr-values-area" style="display: block;">


                                <input type="hidden" class="form-control" name="attr_vid" value="1335">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <div class="form-control-box">
                            ...
                            <input type="text" id="attributemodel-attr_sort" class="form-control small" name="AttributeModel[attr_sort]" value="{{ $v->attr_sort }}">
