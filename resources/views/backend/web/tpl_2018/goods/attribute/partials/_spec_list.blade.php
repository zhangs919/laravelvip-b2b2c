<div class="table-responsive">
    ...
    <table id="table_list" class="table table-hover">
        ...
        <tr>
            ...
            <th data-sortname="attr_name" data-sortorder="asc" style="cursor: pointer;">规格名称<span class="sort"></span></th>
            <th data-sortname="type_id" data-sortorder="asc" style="cursor: pointer;">商品类型<span class="sort"></span></th>
            <th data-sortname="attr_style" data-sortorder="asc" style="cursor: pointer;">样式<span class="sort"></span></th>
            <th>规格值</th>
            <!--
        ...
        <tr>
            ...
            <td class="handle">
                <a href="edit-spec?id={{ $v->attr_id }}&amp;type_id={{ $type_id }}">编辑</a>
                <span>|</span>
