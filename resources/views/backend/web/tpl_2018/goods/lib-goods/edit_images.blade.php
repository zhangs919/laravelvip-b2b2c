                        ...
                        <ul class="goods-pic-list">
                            ...
                            <li class="goodspic-upload image-item">
                                <div class="upload-thumb">
                                    ...
                                    <img src="http://68yun.oss-cn-beijing.aliyuncs.com/images/14719/taobao-yun-images/531610068386/TB1O0Z.MVXXXXXPXVXXXXXXXXXX_!!0-item_pic.jpg?x-oss-process=image/resize,m_pad,limit_0,h_220,w_220">
                                    ...
                                    <div class="upload-btn">
                                        <a href="javascript:void(0);">
											<span class="image-upload">
												...
												<input type="hidden" name="goods_images[default][0][path]" value="/taobao-yun-images/531610068386/TB1O0Z.MVXXXXXPXVXXXXXXXXXX_!!0-item_pic.jpg" class="image-path">
											</span>
                                            <p>
                                    ...
                                    <div class="upload-btn">
                                        <a href="javascript:void(0);">
											<span class="image-upload">
												...
												<input type="hidden" name="goods_images[default][1][path]" value="/taobao-yun-images/531610068386/TB1O0Z.MVXXXXXPXVXXXXXXXXXX_!!0-item_pic.jpg" class="image-path">
											</span>
                                            <p>
                                                <i class="fa fa-upload"></i>
                                                上传
                            ...
                            <li class="goodspic-upload image-item">
                                <div class="upload-thumb">
                                    ...
                                    <img src="http://68yun.oss-cn-beijing.aliyuncs.com/images/14719/taobao-yun-images/531610068386/TB24x_hX8LzQeBjSZFjXXcscpXa_!!725677994.jpg?x-oss-process=image/resize,m_pad,limit_0,h_220,w_220">
                                    ...
                                    <div class="upload-btn">
                                        <a href="javascript:void(0);">
											<span class="image-upload">
												...
												<input type="hidden" name="goods_images[default][2][path]" value="/taobao-yun-images/531610068386/TB24x_hX8LzQeBjSZFjXXcscpXa_!!725677994.jpg" class="image-path">
											</span>
                                            <p>
                                                <i class="fa fa-upload"></i>
                                                上传
                            ...
                            <li class="goodspic-upload image-item">
                                <div class="upload-thumb">
                                    ...
                                    <img src="http://68yun.oss-cn-beijing.aliyuncs.com/images/14719/taobao-yun-images/531610068386/TB2DgUioXXXXXXGXFXXXXXXXXXX_!!2136152958.jpg?x-oss-process=image/resize,m_pad,limit_0,h_220,w_220">
                                    ...
                                    <div class="upload-btn">
                                        <a href="javascript:void(0);">
											<span class="image-upload">
												...
												<input type="hidden" name="goods_images[default][3][path]" value="/taobao-yun-images/531610068386/TB2DgUioXXXXXXGXFXXXXXXXXXX_!!2136152958.jpg" class="image-path">
											</span>
                                            <p>
                                                <i class="fa fa-upload"></i>
                                                上传
                            ...
                            <li class="goodspic-upload image-item">
                                <div class="upload-thumb">
                                    ...
                                    <img src="http://68yun.oss-cn-beijing.aliyuncs.com/images/14719/taobao-yun-images/531610068386/TB2oD.GoXXXXXcyXXXXXXXXXXXX_!!2136152958.jpg?x-oss-process=image/resize,m_pad,limit_0,h_220,w_220">
                                    ...
                                    <div class="upload-btn">
                                        <a href="javascript:void(0);">
											<span class="image-upload">
												...
												<input type="hidden" name="goods_images[default][4][path]" value="/taobao-yun-images/531610068386/TB2oD.GoXXXXXcyXXXXXXXXXXXX_!!2136152958.jpg" class="image-path">
											</span>
                                            <p>
                                                <i class="fa fa-upload"></i>
                                                上传
    ...
    <script type="text/javascript">
        $().ready(function() {
            ...
            $("#btn_submit").click(function() {
                ...
                $.post('/goods/lib-goods/edit-images?id=5', data, function(result) {
                    // 加载
                    $.loading.stop();
