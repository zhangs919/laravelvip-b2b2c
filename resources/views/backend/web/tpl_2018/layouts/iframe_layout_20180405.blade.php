            ...
            <li id="clear_cache" class="top-menu">
                ...
                <div id="clear_cache_panel" class="manager-menu dropdown-menu colorbg animated fadeInDown">
                    ...
                    <form id="cacheForm" action="/index" method="POST">
                        <input type="hidden" name="_csrf" value="zOtP_dCLssNeIue6nzDausZwmv17s1mBHyZJVziPQl3h3BmMgPyF-xNJlOvtYezQqTjVtkyAKe1TTHo2W9AJaA==">
                    ...
                    <ul class="sm-child">
                        ...
                        <li class="sm-child-li">
                            ...
                            <ul class="sm-three">
                                ...
                                <li class="">
                                    <a href="javascript:void(0);" onclick="openMenu('/shop/cash-oauth/list',this, '')" data-menus="mall|mall-shop|mall-shop-cash-oauth">收银系统授权</a>
                                </li>
                                <li class="">
                                    <a href="javascript:void(0);" onclick="openMenu('/shop/dada/list',this, '')" data-menus="mall|mall-shop|mall-shop-dada">达达配送授权</a>
                                </li>
                        ...
                        <li class="sm-child-li">
                            ...
                            <ul class="sm-three">
                                ...
                                <li class="">
                                    <a href="javascript:void(0);" onclick="openMenu('/user/user/list',this, '')" data-menus="mall|mall-user|mall-user-list">会员列表</a>
                                </li>
                                <li class="">
