...
@section('content')
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <div class="form-control-box">
                            ...
                            <input type="text" id="articlemodel-title" class="form-control" name="ArticleModel[title]" value="{{ $info->title }}">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <div class="form-control-box">
                            ...
                            <input type="text" id="articlemodel-keywords" class="form-control" name="ArticleModel[keywords]" value="{{ $info->keywords }}">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <div class="form-control-box">
                            ...
                            <input type="text" id="start_date" class="form-control form_datetime" name="ArticleModel[add_time]" value="{{ $info->add_time ?? date('Y-m-d H:i:s', time())}}">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <div class="form-control-box">
                            ...
                            <input type="text" id="articlemodel-source" class="form-control" name="ArticleModel[source]" value="{{ $info->source }}">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <div class="form-control-box">
                            ...
                            <input type="hidden" id="articlemodel-article_thumb" class="form-control" name="ArticleModel[article_thumb]" value="{{ $info->article_thumb }}">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <div class="form-control-box">
                            ...
                            <textarea id="articlemodel-summary" class="form-control" name="ArticleModel[summary]" rows="5">{{ $info->summary }}</textarea>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <div class="form-control-box">
                            ...
                            <input type="text" id="articlemodel-link" class="form-control" name="ArticleModel[link]" value="{{ $info->link }}" placeholder="http://">
    ...
    <div class="help-block help-block-t"></div>
            ...
            <div class="simple-form-field">
                <div class="form-group">
                    <label for="articlemodel-status" class="col-sm-3 control-label">
                    ...
                    <div class="col-sm-9">
                        <div class="form-control-box">
                            ...
                            <label class="control-label control-label-spe">
                                <input type="radio" class="icheck" name="ArticleModel[status]" value="0" @if($info->status == 0) checked="" @endif> 未审核
                            </label>
                            <label class="control-label control-label-spe">
                                <input type="radio" class="icheck" name="ArticleModel[status]" value="1" @if($info->status == 1) checked="" @endif> 已通过
                            </label>
                            <label class="control-label control-label-spe">
                                <input type="radio" class="icheck" name="ArticleModel[status]" value="2" @if($info->status == 2) checked="" @endif> 未通过
                            </label>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <div class="form-control-box">
                            ...
                            <input type="text" id="articlemodel-sort" class="form-control small" name="ArticleModel[sort]" value="{{ $info->sort }}">
