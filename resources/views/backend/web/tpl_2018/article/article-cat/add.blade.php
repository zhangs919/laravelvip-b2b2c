...
@section('content')
    ...
    <div class="table-content m-t-30 clearfix">
        <form id="ArticleCatModel" class="form-horizontal" name="ArticleCatModel" action="/article/article-cat/add-category" method="post" enctype="multipart/form-data" novalidate="novalidate">
            @csrf
            <!-- 隐藏域 -->
            <input type="hidden" id="articlecatmodel-cat_id" class="form-control" name="ArticleCatModel[cat_id]">
            <!-- 分类名称 -->
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <div class="form-control-box">
                            ...
                            <input type="text" id="articlecatmodel-cat_name" class="form-control" name="ArticleCatModel[cat_name]">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <div class="form-control-box">
                                ...
                                <select class="form-control chosen-select" name="ArticleCatModel[parent_id]" id="select_cat_id" style="display: none;">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <div class="form-control-box">
                            ...
                            <select class="form-control chosen-select" name="ArticleCatModel[cat_model]" id="select_cat_model" style="display: none;">

                                <option value="1">单网页展示</option>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <div class="form-control-box">
                                ...
                                <select class="form-control chosen-select" name="ArticleCatModel[cat_type]"
                                        id="select_cat_type" style="display: none;">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <div class="form-control-box">
                                ...
                                <label class="control-label">{{ $parent_info->cat_name }}</label><input type="hidden" name="ArticleCatModel[parent_id]" value="{{ $parent_info->cat_id }}">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <div class="form-control-box">
                            ...
                            <label class="control-label">@if($parent_info->cat_model == 1)单网页展示@elseif($parent_info->cat_model == 2)普通展示@endif</label>
                            <input type="hidden" name="ArticleCatModel[cat_model]" value="{{ $parent_info->cat_model }}">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <div class="form-control-box">
                                ...
                                <label class="control-label">{{ article_cat_type($parent_info->cat_type) }}</label>
                                <input type="hidden" name="ArticleCatModel[cat_type]" value="{{ $parent_info->cat_type }}">
