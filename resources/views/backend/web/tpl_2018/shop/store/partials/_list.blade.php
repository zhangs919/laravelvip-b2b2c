<table id="table_list" class="table table-hover">
    <thead>
    <tr>
        <th class="w300" data-sortname="">店铺信息</th>
        <th class="w100 text-c" data-sortname="">允许网点数量</th>
        <th class="w100 text-c" data-sortname="">已添加网点数量</th>
    ...
    <tr>
        ...
        <td class="text-c">{{ $v->store_allow_number }}</td>
        <td class="text-c">{{ $v->store_number }}</td>
        <td class="handle">
