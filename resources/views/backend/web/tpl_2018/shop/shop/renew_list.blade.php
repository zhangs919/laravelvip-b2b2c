...
@section('content')
    ...
    <div class="search-term m-b-10">
        <form id="searchForm" action="/shop/shop/renew-list" method="GET">
    ...
    <div class="table-responsive">
        ...
        {{--引入列表--}}
        @include('shop.shop.partials._renew_list')
    ...
    <script type="text/javascript">
        $().ready(function() {
            ...
            $("#btn_export").click(function() {
                var url = "/shop/shop/export?is_supply=0";
                url += "&renew=1";
