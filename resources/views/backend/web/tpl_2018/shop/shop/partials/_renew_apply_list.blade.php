<table id="table_list" class="table table-hover">
    ...
    <tr>
        ...
        <th class="text-c" data-sortname="shop_status" data-sortorder="asc" style="cursor: pointer;">店铺状态<span class="sort"></span></th>
        <th data-sortname="" style="cursor: default;">申请时间</th>
        <th class="text-c" data-sortname="" style="cursor: default;">续签时长</th>
        <th data-sortname="" style="cursor: default;">续签起止日期</th>
        <th data-sortname="" style="cursor: pointer;" class="">平台使用费（元）</th>
        <th class="text-c" data-sortname="" style="cursor: pointer;">付款状态</th>
        <th class="handle" style="cursor: default;">操作</th>
    </tr>
    </thead>
    <tbody><tr><td class="no-data" colspan="9"><i class="fa fa-exclamation-circle"></i>没有符合条件的记录</td></tr></tbody>
    <tfoot>
    <tr>
        <td colspan="9">
