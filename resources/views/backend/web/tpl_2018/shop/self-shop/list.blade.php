...
@section('style')
    ...
    <script src="/assets/d2eace91/bootstrap/datetimepicker/js/bootstrap-datetimepicker.min.js?v=20180710"></script>
...
@section('content')
    ...
    <div class="search-term m-b-10">
        <form id="searchForm" action="/shop/self-shop/list.html" method="GET">
            ...
            <div class="simple-form-field">
                <div class="form-group">
                    ...
                    <div class="form-control-wrap">
                        <select id="shop_status" name="shop_status" class="form-control" value="">
    ...
    <div class="table-responsive">
        ...
        {{--引入列表--}}
        @include('shop.self-shop.partials._list')
...
@section('footer_script')
    ...
    <script type="text/javascript">
        $().ready(function() {
            ...
            $("#btn_export").click(function() {
                var url = "/shop/self-shop/export.html?is_supply=0";
    ...
    <script type='text/javascript'>
        $(document).ready(function() {
            $(".shop_sort").editable({
                type: "text",
                url: "/shop/self-shop/edit-shop-info",
                pk: 1,
                ajaxOptions: {
                    type: "post"
                },
