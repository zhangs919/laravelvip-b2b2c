...
@section('content')
    ...
    <div class="search-term m-b-10">
        <form id="searchForm" action="/dashboard/freebuy/list.html" method="GET">

            <input type="hidden" id="uid" class="form-control" name="uid">

            <input type="hidden" id="activity_id" class="form-control" name="activity_id">

            <input type="hidden" id="buy_type" class="form-control" name="buy_type" value="4">
    ...
    <div id="table_list">
        ...
        {{--引入列表--}}
        @include('dashboard.freebuy.partials._list')
    </div>
