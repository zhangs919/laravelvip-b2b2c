    ...
    <tr>
        ...
        <td>
            ...
            <div class="ng-binding goods-message w100">
                <div class="name">
                    <a href="{{ route('show_integral_goods', ['goods_id'=>$v->goods_id]) }}" target="_blank" class="goods_name"
                       data-goods_id="{{ $v->goods_id }}" data-toggle="tooltip" data-placement="auto bottom" title="{{ $v->goods_name }}">{{ $v->goods_name }}</a>
        ...
        <td class="handle">
            ...
            <span>|</span>
            <a href="javascript:void(0)" class="edit-goods-status" data-goods_status="1" data-id="{{ $v->goods_id }}">@if($v->goods_status == 1)下架@else上架@endif</a>
            <span>|</span>
