...
@section('content')
    ...
    <form id="Bonus" class="form-horizontal" name="Bonus" action="/dashboard/bonus/add?bonus_type=10" method="post" enctype="multipart/form-data" novalidate="novalidate">
        @csrf
        ...
        <div class="table-content m-t-30 clearfix">
            ...
            <div class="form-horizontal m-t-30">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <div class="form-control-box">
                                ...
                                <input type="text" id="bonus-exchange_points" class="form-control ipt m-r-10 m-l-10" name="Bonus[exchange_points]">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <div class="form-control-box">
                                ...
                                <input type="hidden" name="Bonus[exchange_limit]" value=""><div id="bonus-exchange_limit" class="" name="Bonus[exchange_limit]"><label class="control-label cur-p m-r-10"><input type="radio" name="Bonus[exchange_limit]" value="0" checked=""> 无限制</label>
                                    <label class="control-label cur-p m-r-10"><input type="radio" name="Bonus[exchange_limit]" value="1"> 限制</label></div>
                ...
                <div id="points-div" style="display: none;">
                    <!-- 兑换开始时间 -->
                    <div class="simple-form-field">
                        <div class="form-group">
                            <label for="bonus-exchange_start_time" class="col-sm-3 control-label">
                                <span class="text-danger ng-binding">*</span>
                                <span class="ng-binding">兑换开始时间：</span>
                            </label>
                            <div class="col-sm-9">
                                <div class="form-control-box">


                                    <input type="text" id="bonus-exchange_start_time" class="form-control form_datetime_exchange_start large" name="Bonus[exchange_start_time]" value="">
                    ...
                    <div class="simple-form-field">
                        <div class="form-group">
                            <label for="bonus-exchange_end_time" class="col-sm-3 control-label">
                                <span class="text-danger ng-binding">*</span>
                                <span class="ng-binding">兑换结束时间：</span>
                            </label>
                            <div class="col-sm-9">
                                <div class="form-control-box">


                                    <input type="text" id="bonus-exchange_end_time" class="form-control form_datetime_exchange_end large" name="Bonus[exchange_end_time]" value="">


                                </div>

                                <div class="help-block help-block-t"><div class="help-block help-block-t">在兑换时间内，红包才能正常兑换，否则红包不可兑换</div></div>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <script type="text/javascript">
                    $('input[name="Bonus[exchange_limit]"]').click(function() {
                        if ($(this).val() == 0) {
                            $("#points-div").hide();
                        } else {
                            $("#points-div").show();
                    ...
                    $('.form_datetime_exchange_start').datetimepicker({
                        language: 'zh-CN',
                        todayBtn: 1,
                        autoclose: 1,
                        weekStart: 0,
                    ...
                    $('.form_datetime_exchange_end').datetimepicker({
                        language: 'zh-CN',
                        todayBtn: 1,
                        autoclose: 1,
                        weekStart: 0,
