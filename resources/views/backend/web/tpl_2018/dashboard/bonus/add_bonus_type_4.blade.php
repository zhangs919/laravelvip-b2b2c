...
@section('content')
    ...
    <form id="Bonus" class="form-horizontal" name="Bonus" action="/dashboard/bonus/add?bonus_type=4" method="post" enctype="multipart/form-data" novalidate="novalidate">
        @csrf
            ...
            <div class="simple-form-field">
                <div class="form-group form-group-showcase">
                    ...
                    <div class="col-sm-9">
                        ...
                        <p class="help-block-t">平台主动派发，系统提醒用户获得红包</p>
                    </div>
                </div>
            </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <div class="form-control-box">
                                ...
                                <input type="text" id="bonus-start_time" class="form-control form_datetime_start large" name="Bonus[start_time]" value="2018-02-15 00:00:00">
                                <span class="ctime">至</span>

                                <input type="text" id="bonus-end_time" class="form-control form_datetime_end large" name="Bonus[end_time]" value="2018-02-22 23:59:59">
