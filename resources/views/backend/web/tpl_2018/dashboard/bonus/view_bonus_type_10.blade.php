...
@section('content')
    ...
    <form id="Bonus" class="form-horizontal" name="Bonus" action="/dashboard/bonus/view?bonus_id={{ $model['bonus_id'] }}" method="post" enctype="multipart/form-data" novalidate="novalidate">
        @csrf
        ...
        <div class="table-content m-t-30 clearfix">
            ...
            <div class="form-horizontal m-t-30">
                ...
                <div class="simple-form-field">
                    <div class="form-group">
                        <label for="bonus-exchange_limit" class="col-sm-3 control-label">
                        ...
                        <div class="col-sm-9">
                            <div class="form-control-box">
                                ...
                                <label class="control-label">不限制</label>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <div class="form-control-box">
                                ...
                                <label class="control-label"> 仅限原价购买可用 </label>
