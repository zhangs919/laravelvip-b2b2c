...
<!-- 去预览表单 -->
<form id="to_preview" method="post" target="_blank" action="/dashboard/custom-form/preview?form_id={{ $form_info['form_id'] }}" style="display: none">
    <input name="form_datas" id="form_datas">
    <input name="global_datas" id="global_datas">
</form>
<!-- 提交表单 -->
<form id="to_submit" method="post" action="/dashboard/custom-form/design?form_id={{ $form_info['form_id'] }}" style="display: none"></form>
<!--发布表单成功弹框-->
