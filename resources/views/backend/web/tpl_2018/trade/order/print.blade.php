...
<script src="/assets/d2eace91/js/jquery-ui.js?v=20180919"></script>  <script src="/assets/d2eace91/js/lodop/LodopFuncs.js?v=20180919"></script>
<div id="print">

    <link rel="stylesheet" href="/assets/d2eace91/css/print.css?v=20180927"/>
    <!--A5-->
    <div class="print-page print-layout a4">
        <div class="print-fixed">
            ...
            <div class="print-spec">
                ...
                <select class="form-control w100 select-print-spec">
                    ...
                    <option value="A4纸张" selected="selected">A4纸张</option>
                ...
                <p class="m-t-5">
                    ...
                    <a class="btn btn-primary btn-sm m-t-5" href="/mall/print-spec/list" target="_blank">去设置</a>
                </p>
            </div>
            <div class="tip">
                <dl>
                    <dt>
                        <h1>A4</h1>
                        <em>Size: 210mm x 297mm</em>
                    </dt>
                </dl>
            </div>
            <div class="division-line" style="top: 291mm">
                <span>分页分割线</span>
            </div>
