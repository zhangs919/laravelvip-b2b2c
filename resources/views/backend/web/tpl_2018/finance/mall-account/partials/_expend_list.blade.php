<table id="table_list" class="table table-hover">
    ...
    <tr>
        ...
        <th class="w120" data-sortname="amount" data-sortorder="asc" style="cursor: pointer;">出账（元）<span class="sort"></span></th>

        <th class="w100" data-sortname="pay_name" data-sortorder="asc" style="cursor: pointer;">出账账户<span class="sort"></span></th>
    ...
    @foreach($list as $item)
        <tr>
            ...
            <td>
                ...
                <font class="c-red">-{{ $item->amount }}</font>
