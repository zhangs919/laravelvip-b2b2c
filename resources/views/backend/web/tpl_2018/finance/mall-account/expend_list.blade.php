...
@section('content')
    ...
    <div class="search-term m-b-10 pos-r">
        <form id="searchForm" action="/finance/mall-account/list.html" method="GET">
            <input type="hidden" name="type" value="expend">
                ...
                <div class="simple-form-field">
                    <div class="form-group">
                        ...
                        <div class="form-control-wrap w900">
                            ...
                            <!-- <a class="inline-item category" value="201" href="javascript:void(0);">购物余额支付交易支出</a> -->
                            <a class="inline-item category" value="202" href="javascript:void(0);">在线支付退款</a>
                            <a class="inline-item category" value="203" href="javascript:void(0);">在线支付取消订单</a>
                            <a class="inline-item category" value="204" href="javascript:void(0);">站点扣点</a>
                            <a class="inline-item category" value="205" href="javascript:void(0);">提现</a>
                            <a class="inline-item category" value="206" href="javascript:void(0);">人为调整-减少</a>
    ...
    @include('finance.mall-account.partials._expend_list')
