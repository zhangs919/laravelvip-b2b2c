<table id="table_list" class="table table-hover">
    <thead>
    <tr>
        <th class="w200" data-sortname="add_time" data-sortorder="asc" style="cursor: pointer;">充值时间<span class="sort"></span></th>
        <th class="w200" data-sortname="user_id" data-sortorder="asc" style="cursor: pointer;">会员名称<span class="sort"></span></th>
        <th class="w150 text-c" data-sortname="amount" data-sortorder="asc" style="cursor: pointer;">充值金额<span class="sort"></span></th>
        ...
        <th class="w200 text-c" data-sortname="payment_name" data-sortorder="asc" style="cursor: pointer;">支付方式名称<span class="sort"></span></th>
