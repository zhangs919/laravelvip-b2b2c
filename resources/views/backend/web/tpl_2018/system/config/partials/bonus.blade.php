...
[{"id": "systemconfigmodel-bonus_remind_time", "name": "SystemConfigModel[bonus_remind_time]", "attribute": "bonus_remind_time", "rules": {"string":true,"messages":{"string":"到期提醒时间必须是一条字符串。"}}},{"id": "systemconfigmodel-bonus_remind_time", "name": "SystemConfigModel[bonus_remind_time]", "attribute": "bonus_remind_time", "rules": {"required":true,"messages":{"required":"到期提醒时间不能为空。"}}},{"id": "systemconfigmodel-bonus_remind_time", "name": "SystemConfigModel[bonus_remind_time]", "attribute": "bonus_remind_time", "rules": {"match":{"pattern":/^([0-1][0-9]|2[0-3]):([0-5][0-9]):([0-5][0-9])$/,"not":false,"skipOnEmpty":1},"messages":{"match":"请输入格式为“HH:mm:ss”格式的时间"}}},]
</script>
