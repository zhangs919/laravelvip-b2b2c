...
[{"id": "systemconfigmodel-app_user_center_bgimage", "name": "SystemConfigModel[app_user_center_bgimage]", "attribute": "app_user_center_bgimage", "rules": {"string":true,"messages":{"string":"用户中心背景图片必须是一条字符串。"}}},]
</script>
