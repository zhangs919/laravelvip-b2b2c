...
[{"id": "systemconfigmodel-shop_collect_open", "name": "SystemConfigModel[shop_collect_open]", "attribute": "shop_collect_open", "rules": {"string":true,"messages":{"string":"是否开启店铺数据采集必须是一条字符串。"}}},]
</script>
