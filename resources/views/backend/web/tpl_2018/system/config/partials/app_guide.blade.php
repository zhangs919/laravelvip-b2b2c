...
[{"id": "systemconfigmodel-is_guide_open", "name": "SystemConfigModel[is_guide_open]", "attribute": "is_guide_open", "rules": {"string":true,"messages":{"string":"是否开启引导图必须是一条字符串。"}}},{"id": "systemconfigmodel-app_guide_pic", "name": "SystemConfigModel[app_guide_pic]", "attribute": "app_guide_pic", "rules": {"string":true,"messages":{"string":"引导图片必须是一条字符串。"}}},{"id": "systemconfigmodel-app_guide_pic", "name": "SystemConfigModel[app_guide_pic]", "attribute": "app_guide_pic", "rules": {"required":true,"messages":{"required":"引导图片不能为空。"}}},{"id": "systemconfigmodel-app_enter_button", "name": "SystemConfigModel[app_enter_button]", "attribute": "app_enter_button", "rules": {"string":true,"messages":{"string":"进入按钮必须是一条字符串。"}}},]
</script>
