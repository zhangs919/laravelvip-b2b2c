...
@section('content')
    ...
    <div class="table-content m-t-30 clearfix">
        ...
        <!-- 配置分组 -->
            ...
            <div class="simple-form-field">
                <div class="form-group">
                    <label for="configmodel-unit" class="col-sm-3 control-label">
                        <span class="ng-binding">配置单位：</span>
                    </label>
                    <div class="col-sm-9">
                        <div class="form-control-box">


                            <input type="text" id="configmodel-unit" class="form-control" name="ConfigModel[unit]" value="{{ $info->unit ?? ''}}">


                        </div>

                        <div class="help-block help-block-t"><div class="help-block help-block-t">文本框后面显示的单位标识，如：元、%等</div></div>
                    </div>
                </div>
            </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <div class="form-control-box">
                            ...
                            <textarea id="configmodel-value" class="form-control" name="ConfigModel[value]" rows="5">{{ $info->value ?? ''}}</textarea>
