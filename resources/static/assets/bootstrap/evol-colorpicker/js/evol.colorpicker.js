...
$.widget( "evol.colorpicker", {
	...
	options: {
		...
		strings: '选择色彩,标准色,更多颜色,常用色,返回调色板,历史记录,暂无记录.'//此处原英文，现改为中文
	},
	...
	_create: function() {
		...
		switch(this.element.get(0).tagName){
			case 'INPUT':
				...
				e.addClass('colorPicker '+this._id)//此处原32，现改为45，文本框右侧色值框与文本框之间的距离
					.wrap('<div style="width:'+(this.options.hideButton?this.element.width():this.element.width()+45)+'px;'+
