...
$(function () {
    ...
    $('.SZY-SHOP-STREET-SORT a').click(function () {
        ...
        if ($(this).find('b').length > 0) {
            ...
            $(this).append('<b class="icon-descending iconfont icon-jiantou_xiangshang"></b>');
            sort = sort + '-' + 'desc';
            console.info(sort.indexOf('distance'));
            if (sort.indexOf('distance') == 0) {
                text = text + '由远到近';
            } else {
                text = text + '由高到低';
    ...
    $('.SZY-SHOP-STREET-CLS li').click(function () {
        ...
        if (cls_id == '0') {
            ...
            $('.SZY-SHOP-STREET-CLS-CHR').addClass('hide');
            var $form = $("#searchForm");
